...
function register_user() {
	...
	else if(atpos<1 || dotpos<atpos+2 || dotpos+2>=em.length)
	{
        ...
        if (i == s) {
            ...
            }), alert(valid_captcha), $("#register_captcha").val(""), $("#register_captcha").focus(), !1) : ($("#loading_signup").css("display", "block"), $("#loading_signup_image").css("display", "none"), $.ajax({
                type: "POST",
                ...
                success: function(e) {
					...
					if(e.success ==0) {
						if(e.msgs=='Does not Support Rep Code')
						{
							...
							return $("#emailalert").css("display", "block"),$("#rep_code_alert").css("display", "none");
						}
				//alert(e.msgs);
