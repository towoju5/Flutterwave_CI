...
class Order_model extends My_Model
{
	...
	public function view_order_details($status,$condition='',$rep_code=''){
		$this->db->select('p.*,u.email,u.firstname,u.address,u.phone_no,u.postal_code,u.state,u.country,u.city,pd.product_name,pd.id as PrdID,rq.Bookingno as bookingno,rq.currencyPerUnitSeller');
