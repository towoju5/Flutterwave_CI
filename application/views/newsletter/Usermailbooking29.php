...
<tr>
<td align="left">
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">We're excited to tell you that <?php echo $rental_name; ?> is now booked.To make check-in seamless, we have suggested you to continue the conversation with <?php echo $renter_fname; ?> <?php echo $renter_lname; ?></p>
</td>
</tr>
<tr>
<td align="left">
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">through Vacason message system to confirm your arrival time, ask any questions you may have, and help them figure out how to best get to their listing.</p>
</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<tr>
<td>
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">On the day after you check in, the payout method your host supplied will be credited. For details, see your Transaction History.</p>
</td>
</tr>
<tr>
