...
<tr>
<td align="center" valign="top"><?php echo $travellername; ?> would like to experience at ($productname) from <?php echo $checkindate; ?> through <?php echo $checkoutdate; ?></td>
</tr>
<tr>
<td align="center">Based on your rate of <?php echo $price; ?> per person along with Occupyproperties fees, your potential payout for this booking is <?php echo $totalprice; ?>.</td>
</tr>
<tr>
<td align="center">
...
<tr>
<td align="left" valign="middle"><?php echo $travellername; ?>'s booking request will confirm automatically.&nbsp;Please have a note on it. You can contact guest through the platorm messaging system for further communication.</td>
</tr>
<tr>
<td align="left" valign="middle">We appreciate your response as quickly as possible, so your guest can begin to plan their stay!</td>
</tr>
<tr>
