...
<h1 style="font-size: 20px;">Hi <strong><?php echo $fiestname; ?></strong></h1>
<div style="margin-bottom: 10px; line-height: 1.4; font-size: 16px;"><strong style="margin-bottom: 10px;">Congratulations!</strong></div>
we are very happy to tell that you have received a request from <strong><?php echo guest name; ?></strong> for your property <strong><?php echo $experience_title; ?></strong>.
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">We suggest you continue the conversation with <strong><?php echo guest name; ?></strong> through Occupyproperties message system.</p>
