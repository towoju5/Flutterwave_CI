...
<div>
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;"><strong>OOPS!</strong></p>
Unfortunately, Occupyproperties has <em><strong>unpublished</strong></em> your property <strong><?php echo $product_title; ?></strong> due to some reasons. Currently, it is not showing in search results. Please contact Occupyproperties&nbsp; immediately.</div>
