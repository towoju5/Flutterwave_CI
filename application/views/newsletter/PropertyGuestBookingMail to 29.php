...
<tr>
<td align="left">
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">We're excited to tell you that <?php echo $rental_name; ?> is now booked for you.To make check-in seamless, we have suggested you to continue the conversation with <?php echo $renter_fname; ?> <?php echo $renter_lname; ?></p>
</td>
</tr>
<tr>
<td align="left">
<p style="margin-bottom: 10px; color: #484848; font-size: 16px;">through Occupyproperties internal messaging system to confirm your arrival time, ask any questions you may have, and help you figure out how best to get to their listing.</p>
</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<p>The host or agent will receive the payment from Occupyproperties after 24 hours. To know more see your Transaction Details.</p>
