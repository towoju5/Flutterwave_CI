...
<tr>
<td style="border-bottom: 1px solid #bbb;">Cleaning Fee</td>
<td style="border-bottom: 1px solid #bbb;">&nbsp;</td>
<td style="border-bottom: 1px solid #bbb; padding: 5px 0px;"><?php echo $currency_symbol; ?><?php echo $cleaningFee; ?><?php echo $currency_type; ?></td>
</tr>
<tr>
