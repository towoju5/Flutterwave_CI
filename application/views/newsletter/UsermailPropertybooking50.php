...
<tr>
<td align="left">
<p style="font-size: 16px; line-height: 1.7; margin-bottom: 10px;">through Occupyproperties message system to confirm their arrival time, ask any questions you may have, and help them figure out how to best get to your listing.</p>
</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<div><a href="http://airbnb.zoplay.com/rental/<?php echo $prd_id; ?>"><img src="<?php echo $rental_image; ?>" alt="" width="300" /></a></div>
<div><a style="display: block; margin: 10px 0px;" href="http://airbnb.zoplay.com/rental/<?php echo $prd_id; ?>"><?php echo $RENTAL_NAME; ?></a></div>
</td>
</tr>
<tr>
<td align="left">
