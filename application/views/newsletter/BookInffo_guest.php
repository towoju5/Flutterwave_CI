...
<td align="center">Based on your price of <?php echo $currencySymbol; ?><?php echo $price; ?> per night along with Vacason&nbsp;fees, your potential payout for this reservation is&nbsp;<?php echo $currencySymbol; ?> <?php echo $totalprice; ?>.</td>
