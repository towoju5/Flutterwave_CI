...
<tr>
	...
	<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">Dear Admin,</span>
	<br />
	<p>User Name : <?php echo $username;?></p>
    <p>Email : <?php echo $email;?></p>
    <p>Mobile : <?php echo $phone;?></p>
	<br />
	<div >Message : <?php echo $message1;?></div>
	<br />
  ...
  <?php echo $username;?>.<br/>
	...
	<img src="<?php echo base_url();?>images/LOGO4.png" align="center" style="padding-left:10px; padding-top:10px; padding-bottom:10px; width: 200px;" alt=""/>
	<br />	</td>
	</tr>
	</table>
...
<div style="clear:both; margin-top:0em; margin-bottom:1em;"><a href="http://homestaydnn.laravelecommerce.com/" target="_blank" rel="nofollow" class="uec08312c8a736c8761f952d84f851be0">http://homestaydnn.laravelecommerce.com/<div style="padding-left:1em; padding-right:1em;"></div></a></div>
	<br />
	</td>
	</tr>
	</table>
