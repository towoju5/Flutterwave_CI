...
<tr>
<td class="editable" style="color: #ffffff; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 18px; font-weight: bold; text-transform: uppercase; padding: 8px 20px; background-color: #752b7e;" align="center" valign="middle">Hi Admin</td>
</tr>
<tr>
<td height="50">&nbsp;</td>
</tr>
<tr>
<td style="color: #000; padding: 0px 20px; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 13px;" align="center">We're excited to tell you that <?php echo $first_name; ?> <?php echo $last_name; ?> just booked <?php echo $rental_name; ?> with <?php echo $renter_fname; ?> <?php echo $renter_lname; ?></td>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
