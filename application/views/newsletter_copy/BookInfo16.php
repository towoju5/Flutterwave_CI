...
<tr>
<td align="center">Based on your price of <?php echo $price; ?> per night along with HOMESTAYDNN&nbsp;fees, your potential payout for this reservation is <?php echo $totalprice; ?>.</td>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
...
<div><a>Accept</a> /  <a href="<?php echo base_url(); ?>/listing/all">Decline</a></div>
</td>
</tr>
<tr>
<td align="center">
