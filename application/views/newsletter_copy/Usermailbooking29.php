...
<tr>
 <td  align="center">We're excited to tell you that <?php echo $rental_name; ?> is booked now.To make check-in seamless, we have suggest you to continue the conversation with <?php echo $renter_fname; ?> <?php echo $renter_lname; ?></td>
</tr>
<tr>
...
<tr>
 <td >On the day after the guest checks in, the payout method you supplied will be credited. For details, see your Transaction History.</td>
</tr>
<tr>
<td height="30">&nbsp;</td>
</tr>
...
<tr>
 <td >Flexible: Full refund 1 day prior to arrival, except fees</td>
</tr>
<tr>
<td height="30">&nbsp;</td>
</tr>
...
<p>Thanks!</p>
<p>The Home<span><span>StayDnn</span></span> Team</p>
</td>
</tr>
<tr>
<td height="30">&nbsp;</td>
