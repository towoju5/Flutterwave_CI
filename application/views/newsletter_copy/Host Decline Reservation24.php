...
<tr>
<td class="editable" style="color: #ffffff; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 18px; font-weight: bold; text-transform: uppercase; padding: 8px 20px; background-color: #752b7e;" align="center" valign="middle">Hi <?php echo $travelername; ?>,</td>
</tr>
<tr>
<td height="30">&nbsp;</td>
</tr>
...
<tr>
<th style="color: #000; padding: 0px 20px; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 13px;" align="center"><span>The <?php echo $propertyname; ?> h</span>ost have declined your reservation. Kindly find alternative accomodation at homestaydnn.laravelecommerce.com. We look forward for your next booking.&nbsp;</th>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
