...
<?php 
 //if ($pay_option->row()->pay_option == 'Request to book') { ?>
<!--<div class="submit-link">
	<a class="booking-btn" onclick="return  BookingIt_new();" href="javascript:void(0);"><?php 
/* 		if($this->lang->line('book_now') != '') {
		echo stripslashes($this->lang->line('book_now')); 
...
<div class="submit-link">
	...
	<a id ="pay_option" <?php  if($this->session->userdata("fc_session_user_id")==''){ ?> class="login-popup booking-btn" <?php } 
else { ?>  class="booking-btn" onclick="return  BookingIt_new('book_now');" href="javascript:void(0);" <?php } ?>  href="javascript:void(0);"><?php 
