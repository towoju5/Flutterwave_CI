...
.ui-datepicker .ui-datepicker-header{background:#e2e2e2 !important}
...
.browse_div2 .showlist3 a{ margin-left:0px;}  
...
@media (max-width: 980px){
	...
	.multiCarousel .col-md-9 img{ margin-bottom:10px;}
            ...
            <div id="carousel-example-generic" class="slide">              
				...
				{  ?> <div class="coverimg">
		          ...
		          <li class="item active">
				     ...
				     <a href="javascript:void(0);"><img src="server/php/rental/dummyProductImage.jpg" data-gallery="first-gallery" alt=""/></a>
        ...
        <div class="detail-middle go_down">
            ...
            <div class="listing-menu">
                 ...
                 <div class="listing-menu-left">
				  ...
				  <?php if($product->loginUserType == 'google') {  ?>

				  <img src="<?php echo $product->thumbnail;?>" alt="HostImageG">
				  ...
				  <?php }else{  ?>
						...
						$url=getimagesize($base.'images/users/'.$product->thumbnail);
						...
						<?php if ($product->thumbnail  != '' && $img=='0') { ?>

							<img src="<?php echo base_url();?>images/users/<?php echo $product->thumbnail; ?>" alt="HostImage">

						<?php }else {  ?>

							<img src="<?php echo base_url();?>images/site/profile.png" alt="HostImage">
...
<!-- <center><img src="images/slider/hom3.png" alt=""></center>-->
						...
						$getlistImage=$this->product_model->get_all_details(LISTSPACE_VALUES,array('id'=>$product->home_type)); 
						...
						$theImage=$getlistImage->row()->image;
						 ...
						 $base =base_url();
								...
								$url=getimagesize($base.'images/attribute/'.$theImage);
						 ...
						 if ($theImage!='' && $img=='0' ){ ?>
							 ...
							 <center> <img src="images/attribute/<?php echo $theImage; ?>" alt="">  </center>
                        ...
                        <p class="p1_prdt_dtls">	<?php echo  ucfirst($listings_hometype);?></p>
                  ...
                  <?php } if($product->accommodates !='') {
					  ...
					  ?>
                       ...
                       <td>
                         ...
                         <span><?php echo $childNameDisplay;?> <?php if($childNameDisplay==1) { if($this->lang->line('guest_single') != '') { echo stripslashes($this->lang->line('guest_single')); } else echo "Bedroom"; } else { if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guests";} ?></span>
					...
					<?php 
							...
							<?php if($listingResult == 26 && $valu >= 1){?>

							<td>



							 <center><img src="images/slider/bath.png" alt=""></center>



							 <span><?php echo stripslashes(ucfirst($valu)); ?> <?php if($valu==1) { if($this->lang->line('bathroom') != '') { echo stripslashes($this->lang->line('bathroom')); } else echo "Bathroom";} else { if($this->lang->line('bathrooms') != '') { echo stripslashes($this->lang->line('bathrooms')); } else echo "Bathrooms"; }?></span>
							...
							<?php if($listingResult == 44 && $valu >= 1){?>
							...
							<td>
							 ...
							 <span><?php echo stripslashes(ucfirst($valu)); ?> <?php if($valu==1) { if($this->lang->line('bedroom_single') != '') { echo stripslashes($this->lang->line('bedroom_single')); } else echo "Bedroom"; } else { if($this->lang->line('bedrooms') != '') { echo stripslashes($this->lang->line('bedrooms')); } else echo "Bedrooms";}?></span>
			...
			<div class="left-listg-container" id="about-listing-text">
           ...
           <?php if($this->lang->line('read_more') != '') { echo stripslashes($this->lang->line('read_more')); } else echo "Read more"; ?>
			...
			<?php 
...

				{
					...
					?>
							...
							<iframe width="100%" height="350px" src="https://www.youtube.com/embed/<?php echo $id ?>?rel=0&showinfo=0&color=white&iv_load_policy=3">
			...
			<article class="descri-section" id="ritespace_first">
                ...
                <ul class="right-space">
							...
							$finalsListing= json_decode($listings_values); //from fc_product

							



							foreach($finalsListing as $listingResult => $FinalValues)  //26:84
							...
							<li>
								...
								<span><?php //echo str_replace("_", " ", $listingResult); 
									...
									echo str_replace("_", " ", $list_type->row()->labelname);
					...
					if(!empty($newAmenities)){
						...
						foreach($newAmenities as $details){
							...
							if(in_array($key,$sub_list)){
								...
								//$v_d='class="amore'.$list->id.'" style="display:block;" '; 

								if($mcount>4){ if(!in_array($key,$sub_list)){ $v_d='style="display:none;"'; } else { $v_d='class="" style="display:block;" ';
						...
						?>
							...
							<article class="descri-section new-line">
								...
								<?php if($listValues->num_rows > 5){ ?>
									...
									<a class="moretag" href="javascript:void(0);" onclick="displydesc11<?php echo $list->id;?> (this)" style="float:right;display: none;">+ <?php if($this->lang->line('more') != '') { echo stripslashes($this->lang->line('more')); } else echo "more";?></a>
...
-->
						...
						<?php if($product->cancel_percentage!='') { ?>
                         ...
                         <li > <span class="label_inside">



						 <?php if($this->lang->line('SecurityDeposit') != '') { echo stripslashes($this->lang->line('SecurityDeposit')); } else echo "Security Deposit";?>: </span>
					...
					<?php
                     ...
                     ?> <?php echo $this->session->userdata('currency_type');?></label>
						...
						<?php if($product->Cleaning_fees!='') { ?>
						 ...
						 <?php if($this->lang->line('cleaningfee') != '') { echo stripslashes($this->lang->line('cleaningfee')); } else echo "Cleaning Fee";?>: </span>
					...
					<?php
                     ...
                     echo convertCurrency($product->currency,$this->session->userdata('currency_type'),$product->Cleaning_fees);

                     }

                     else{

                     	 echo $product->Cleaning_fees;
			...
			<?php //} ?>
                ...
                <span class="left-space newspace tct_clr"><?php if($this->lang->line('list_Description') != '') { echo stripslashes($this->lang->line('list_Description')); } else echo "Description";?></span>
...
<!--......... .......... .......... FOR EMPTY SPACE....................-->
 ...
 <input type="text" placeholder="<?php if($this->lang->line('dd-mm-yyyy') != '') { echo stripslashes($this->lang->line('dd-mm-yyyy')); } else echo "dd-mm-yyyy";?>" autocomplete="off" name="datefrom" readonly="readonly" style="cursor:pointer;"  id="datefrom" class="checkin ui-datepicker-target"  value="<?php if($this->session->userdata('searchFrom') != '') echo $this->session->userdata('searchFrom'); if($this->session->userdata('datefrom')!='') echo $this->session->userdata('datefrom');?>" />
	              ...
	              <!--input type="text" placeholder="<?php if($this->lang->line('dd-mm-yyyy') != '') { echo stripslashes($this->lang->line('dd-mm-yyyy')); } else echo "dd-mm-yyyy";?>" autocomplete="off" name="datefrom" readonly="readonly" style="cursor:pointer;" id="datefrom" class="checkin ui-datepicker-target"  value="<?php if($this->session->userdata('searchFrom') != '') echo $this->session->userdata('searchFrom'); ?>" /-->
						...
						<?php } ?> 
	                     ...
	                     <li>
							...
							if($product->accommodates!=''){
								...
								$getChildName=$this->product_model->get_all_details(LISTING_CHILD,array('id'=>$product->accommodates));

								$childNameDrop=$getChildName->row()->child_name;
...
if($productlist->id_verified=="No"){
	...
	echo '<p class="err-msg1">Host is not verified Yet..!</p>';
...
<div id="price_div" <?php echo $show_book; ?>><?php  if($this->session->userdata('datefrom')!="" && $this->session->userdata('expiredate')!="" && $this->session->userdata('number_of_guests')!=""	) { ?>
...
<label class="date-year"><i><?php echo  date('d F Y',strtotime($review['dateAdded']));?></i></label>
...
<div class="host-contact-btn" style="display: none;"><a id="prodpg_btn" data-toggle="modal" class="view-prof" href="#myModal-host"><?php if($this->lang->line('contact_host') != '') { echo stripslashes($this->lang->line('contact_host')); } else echo "Contact host";?></a></div>
...
<?php  if(count($DistanceQryArr->result()) > 0){ ?>
  ...
  <div class="center" style="width: 960px; margin: 0 auto;">
	...
	<div class="slides">
		...
		<?php  if(count($DistanceQryArr->result()) > 3){ ?>
...
alert("<?php if($this->lang->line('Minimum_Stay_Shoud_be') != '') { echo stripslashes($this->lang->line('Minimum_Stay_Shoud_be')); } else echo "Minimum Stay Shoud be";?> "+<?php echo $valu;?>+' <?php if($this->lang->line('Days') != '') { echo stripslashes($this->lang->line('Days')); } else echo "Days";?>');
    ...
    $('#book_it_status').html('<div align="center"><img src="images/load-indicator.gif" align="center" /></div>');
		...
		*/
        ...
        $.ajax({
            ...
            data: {"checkin":checkin,"checkout":checkout,'numofdates':diff,"NoofGuest":NoofGuest,"cancel_percentage":cancel_percentage,"prd_id":prd_id,"renter_id":renter_id,"serviceFee":servicefee,"totalAmt":totalamt,"subTotal":subTotal,"secDeposit":secDeposit,"cleaningFee":cleaningFee,"walletAmount":walletAmount,"currencycode":currencycode,"user_currencyCode":user_currencyCode,"choosed_option":choosed_option},
