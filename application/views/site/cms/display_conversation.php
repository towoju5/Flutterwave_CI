...
receiver_id="<?php echo $sender_id;?>" product_id="<?php echo $pageDetails->row()->rental_id;?>" reviewer_id="<?php  echo $receiver_id; ?>"><?php if($this->lang->line('reply') != '') { echo stripslashes($this->lang->line('reply')); } else echo "Reply";?></a>&nbsp;<a href="<?php echo base_url().'inbox';?>"><?php if($this->lang->line('back') != '') { echo stripslashes($this->lang->line('back')); } else echo "Back";?></a>
</div>			
</div>
</section>
	</div>
