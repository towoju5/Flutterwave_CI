...
?>
    ...
    <div class="popup ly-title newadds-frm" >
		...
		<form class="ltxt" method="post" id="shippingAddForm" action="<?php echo $acURL;?>" accept-charset="UTF-8">
		...
		<button class="ly-close" title="<?php if($this->lang->line('Close') != '') { echo stripslashes($this->lang->line('Close')); } else echo "Close";?>"><i class="ic-del-black"></i></button>
	...
	<div class="popup ly-title editadds-frm" >
		...
		<form class="ltxt" method="post" id="shippingEditForm" action="site/user_settings/insertEdit_shipping_address" accept-charset="UTF-8">
...
<div class="popup thing-detail no-end-days" style="display:none;">
	...
	<div class="photo-frame">
		...
		<a href="#prev" title="<?php if($this->lang->line('Prev') != '') { echo stripslashes($this->lang->line('Prev')); } else echo "Prev";?>" class="move prev disabled"><span class="arrow"></span></a>


		<a href="#next" title="<?php if($this->lang->line('Next') != '') { echo stripslashes($this->lang->line('Next')); } else echo "Next";?>" class="move next disabled"><span class="arrow"></span></a>
...
<div style="display:none;margin-top: 5px; margin-left: 750.5px; opacity: 1;" show_when_fancy="<?php if ($userDetails->row()->display_lists == 'Yes'){echo 'true';}else {echo 'false';}?>" class="popup ly-title update add-to-list animated" id="add-to-list-new" >
	...
	<div class="default" style="display: block;">
		...
		<p class="ltit uiu"><?php if($this->lang->line('header_add_list') != '') { echo stripslashes($this->lang->line('header_add_list')); } else echo "Add to List"; ?></p>
	...
	<div style="display: none;" class="create-list">
		...
		<button title="<?php if($this->lang->line('Close') != '') { echo stripslashes($this->lang->line('Close')); } else echo "Close";?>" class="close cancel"><i class="ic-del-black"></i></button>
...
<div style="margin-top: 218px; margin-left: 770.5px; opacity: 1; display: none;" class="popup change-photo none animated">
	...
	<form id="form-photo" method="post" action="site/user_settings/change_photo" enctype="multipart/form-data"  accept-charset="UTF-8">
...
<div uname="<?php if ($loginCheck != ''){echo $userDetails->row()->user_name;}?>" class="popup ly-title share-new" id="fancy-share" style="display:none;">
	...
	<div class="share-via">
		...
		<ul class="less">
			...
			<li><a target="_blank" class="fb" href="#"><span class="ic-fb"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Facebook') != '') { echo stripslashes($this->lang->line('Facebook')); } else echo "Facebook";?></em></a></li>


			<li><a target="_blank" class="tw" href="#"><span class="ic-tw"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Twitter') != '') { echo stripslashes($this->lang->line('Twitter')); } else echo "Twitter";?></em></a></li>


			<li><a target="_blank" class="gg" id="gplus-share" href="#"><span class="ic-gg"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Google plus') != '') { echo stripslashes($this->lang->line('Google plus')); } else echo "Google plus";?></em></a></li>

			<li><a target="_blank" class="su" href="#"><span class="ic-su"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('StumbleUpon') != '') { echo stripslashes($this->lang->line('StumbleUpon')); } else echo "StumbleUpon";?></em></a></li>


			<li><a target="_blank" class="li" href="#"><span class="ic-link"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('LinkedIn') != '') { echo stripslashes($this->lang->line('LinkedIn')); } else echo "LinkedIn";?></em></a></li>


			<li><a target="_blank" class="tb" href="#"><span class="ic-tb"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Tumblr') != '') { echo stripslashes($this->lang->line('Tumblr')); } else echo "Tumblr";?></em></a></li>


			<li><a target="_blank" class="vk" href="#"><span class="ic-vk"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('BKohtakte') != '') { echo stripslashes($this->lang->line('BKohtakte')); } else echo "BKohtakte";?></em></a></li>


			<li><a target="_blank" class="od" href="#"><span class="ic-od"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('OnHOKnaccHNKN') != '') { echo stripslashes($this->lang->line('OnHOKnaccHNKN')); } else echo "OnHOKnaccHNKN";?></em></a></li>


			


			<li><a class="mx" href="#"><span class="ic-mx"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('mixi') != '') { echo stripslashes($this->lang->line('mixi')); } else echo "mixi";?></em></a></li>


			<li><a target="_blank" class="qz" href="#"><span class="ic-qz"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('q-zone') != '') { echo stripslashes($this->lang->line('q-zone')); } else echo "q-zone";?></em></a></li>


			<li><a target="_blank" class="wb" href="#"><span class="ic-wb"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Weibo') != '') { echo stripslashes($this->lang->line('Weibo')); } else echo "Weibo";?></em></a></li>


			<li><a class="mx" href="#"><span class="ic-re"></span> <em><?php if($this->lang->line('header_share_on') != '') { echo stripslashes($this->lang->line('header_share_on')); } else echo "Share on "; ?><?php if($this->lang->line('Renren') != '') { echo stripslashes($this->lang->line('Renren')); } else echo "Renren";?></em></a></li>
...
<!-- 		<li><a href="#.embed">Embed</a></li> -->
	...
	<button title="<?php if($this->lang->line('Close') != '') { echo stripslashes($this->lang->line('Close')); } else echo "Close";?>" class="ly-close" type="button"><i class="ic-del-black"></i></button>
...
<div id="clone-list" class="popup clone-list">
	...
	<div class="box-rnd-shadow-2 ly-title">
		...
		<button type="button" class="ly-close" title="<?php if($this->lang->line('Close') != '') { echo stripslashes($this->lang->line('Close')); } else echo "Close";?>"><i class="ic-del-black"></i></button>
