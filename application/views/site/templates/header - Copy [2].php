      ...
      <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="nav-collapse navbar-collapse my-nav">
                ...
                <li><a href="<?php  echo base_url();?>explore_experience"><?php if($this->lang->line('social_dining') != '') { echo stripslashes($this->lang->line('social_dining')); } else echo "Social Dining"; ?></a></li>
<li><a href="<?php  echo base_url();?>explore_experience"><?php if($this->lang->line('events') != '') { echo stripslashes($this->lang->line('events')); } else echo "Events"; ?></a></li>
<li><a href="<?php  echo base_url();?>explore_listing"><?php if($this->lang->line('nomads') != '') { echo stripslashes($this->lang->line('nomads')); } else echo "Nomads"; ?></a></li>
...
<li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Create Experiences & Adventures"; ?>
                        ...
                        <li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('create_social_dining') != '') { echo stripslashes($this->lang->line('create_social_dining')); } else echo "Create Social Dining"; ?>
						</a></li>
                        
                         <li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('create_events') != '') { echo stripslashes($this->lang->line('create_events')); } else echo "Create Events"; ?>
						</a></li>
                        
                         <li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('create_nomads')  != '') { echo stripslashes($this->lang->line('create_nomads')); } else echo "Nomads"; ?>
						</a></li>
