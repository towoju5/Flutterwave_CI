...
<title><?php echo $title;?></title><?php }else {?><title><?php echo $heading;?></title><?php }?>
...
<link rel="stylesheet" href="css/style7.css"><link rel="stylesheet" media="all" href="css/help-style.css" type="text/css" />
<link rel="stylesheet" href="css/home/responsive-tabs.css">
<link rel="stylesheet" href="css/home/globle.css">
<!--
...
<script src="<?php echo base_url()?>js/new/responsive-tabs.js"></script>
<script src="<?php echo base_url()?>js/site/moment.js"></script>
            ...
            <div class="popup_detail">
            	...
            	<div class="banner_signup">
							...
							<?php } ?>
                                 ...
                                 <input type="text" name="email" onblur="ShowPassword(this.value)" id="signin_email_address" value="" class="decorative-input" placeholder="<?php if($this->lang->line('signup_emailaddrs') != '') { echo stripslashes($this->lang->line('signup_emailaddrs')); } else echo "Email Address"; ?>" 
                                ...
                                <span class="popup_stay">
								<!-- id="remember"-->
								<input class="check"  id="remember_me" type="checkbox" /><?php if($this->lang->line('remember_me') != '') { echo stripslashes($this->lang->line('remember_me')); } else echo "Remember Me";?></span>
...
<?php  } ?>
                                 ...
                                 <input type="password" id="password" value=""  placeholder="<?php if($this->lang->line('signup_password') != '') { echo stripslashes($this->lang->line('signup_password')); } else echo "Password"; ?>" class="decorative-input1" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
                                  <input type="password" id="cnf_password"  placeholder="Confirm password" value="" class="decorative-input1" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" />
      ...
      <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="nav-collapse navbar-collapse my-nav">
				...
				<a <?php if ($loginCheck == ''){?> href="javascript:void(0);" class="login-popup ren-sp" <?php } else { ?> href="explore_experience" <?php } ?>  class="request-trip" >
				<img src="<?php echo base_url(); ?>images/cat_icon/09.png">
				<?php if($this->lang->line('experience_on_header') != '') { 
				echo stripslashes($this->lang->line('experience_on_header')); } else echo "Experience";?>
				<i class="caret"></i></a>
				<ul class="showlist3" ><span class="ard"></span>
				<li ><a href="explore_listing"  class="request-trip" ><?php if($this->lang->line('properites') != '') { echo stripslashes($this->lang->line('properites')); } else echo "Properites";?></a></li>
				<li><a href="explore_experience"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Experiences & Adventures"; ?></a></li>
                <li><a href="<?php  echo base_url();?>booking/category/food-hosting"><?php if($this->lang->line('social_dining') != '') { echo stripslashes($this->lang->line('social_dining')); } else echo "Social Dining"; ?></a></li>
<li><a href="<?php  echo base_url();?>booking/category/events"><?php if($this->lang->line('events') != '') { echo stripslashes($this->lang->line('events')); } else echo "Events"; ?></a></li>
<li><a href="<?php  echo base_url();?>booking/category/work-spaces-jobs"><?php if($this->lang->line('nomads') != '') { echo stripslashes($this->lang->line('nomads')); } else echo "Nomads"; ?></a></li>
				...
				<li class="browse_div2 bocom-host" id="broswe_box1">
				 ...
				 <img src="<?php echo base_url(); ?>images/cat_icon/06.png">
				 <?php if($this->lang->line('Become_Host') != '') { echo stripslashes($this->lang->line('Become_Host')); } else echo "Become a Host	";?>
				 <i class="caret"></i></a>             
					<ul class="showlist3" >
						<span class="ard"></span>
						
						
<li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('create_properties') != '') { echo stripslashes($this->lang->line('create_properties')); } else echo "Create Properties"; ?></a></li>
<li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Create Experiences & Adventures"; ?>
						</a></li>
<li><a href="<?php  echo base_url();?>booking/users/register/manual"><?php if($this->lang->line('create_social_dining') != '') { echo stripslashes($this->lang->line('create_social_dining')); } else echo "Create Social Dining"; ?></a></li>
<li><a href="<?php  echo base_url();?>booking/users/register/manual"><?php if($this->lang->line('create_events') != '') { echo stripslashes($this->lang->line('create_events')); } else echo "Create Events"; ?></a></li>
<li><a href="<?php  echo base_url();?>booking/users/register/manual"><?php if($this->lang->line('create_nomads') != '') { echo stripslashes($this->lang->line('create_nomads')); } else echo "Create Nomads"; ?></a></li>
				...
				<?php if ($loginCheck == ''){?> 
				   ...
				   <li class="bocom-host"><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('signup') != '') { echo stripslashes($this->lang->line('signup')); } else echo "sign up"; ?></a></li>
                    ...
                    <?php $actual_link1 = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; 
...
<div class="sidebar-menu-new">
  <ul class="sidebar-list">
				 ...
				 <li class="sidebar-item"><a class="sidebar-anchor" <?php if ($loginCheck == ''){?> href="popular" class="" <?php } else { ?> href="popular" <?php } ?>  ><?php if($this->lang->line('popular') != '') { echo stripslashes($this->lang->line('popular')); } else echo "Popular";?></a></li>
					<li class="sidebar-item"><a  class="sidebar-anchor" href="<?php echo base_url();?>explore_experience"><?php if($this->lang->line('experience_on_header') != '') { echo stripslashes($this->lang->line('experience_on_header')); } else echo "Experiences"; ?></a></li>

                    <li class="sidebar-item"><a  <?php if ($loginCheck == ''){?> class="login-popup ren-sp sidebar-anchor" href="javascript:void(0);"  <?php } else { ?> href="list_space" class="ren-sp sidebar-anchor" <?php } ?>  ><?php if($this->lang->line('list_your') != '') { echo stripslashes($this->lang->line('list_your')); } else echo "List Your Space";?></a></li>
				 <li class="sidebar-item"><a  <?php if ($loginCheck == ''){?> href="javascript:void(0);" class="login-popup ren-sp sidebar-anchor"  <?php } else { ?> href="<?php echo base_url();?>manage_experience" class="ren-sp sidebar-anchor" <?php } ?>  ><?php if($this->lang->line('create_experience') != '') { echo stripslashes($this->lang->line('create_experience')); } else echo "List Your Space";?></a></li>
...
<!--new-->
                    ...
                    <li class="sidebar-item"><a class="sidebar-anchor" href="<?php echo base_url();?>account-payout"><?php if($this->lang->line('referrals_account') != '') { echo stripslashes($this->lang->line('referrals_account')); } else echo "Account"; ?></a></li>
                    
                    <!--Wallet - referal amount display -->
                    
                    <li class="sidebar-item"><a class="sidebar-anchor" href="<?php echo base_url();?>your-wallet"><?php if($this->lang->line('wallets') != '') { echo stripslashes($this->lang->line('wallets')); } else echo "Wallet(".$currencySymbol.' '.convertCurrency('USD',$this->session->userdata('currency_type'),$userDetails->row()->referalAmount).")"; ?></a></li>
...
<script>
<!--Preetha - Start - Remember me-->
$(function() {
	if (localStorage.chkbx && localStorage.chkbx != '') {
		$('#remember_me').attr('checked', 'checked');
		$('#signin_email_address').val(localStorage.usrname);
		$('#signin_password').val(localStorage.pass);
	} else {
	...
	if ($('#remember_me').is(':checked')) {
		...
		localStorage.usrname = $('#signin_email_address').val();
		localStorage.pass = $('#signin_password').val();
...
function ShowPassword(email){
	if (localStorage.chkbx && localStorage.chkbx != '') {
		$.ajax({
			type:'POST',
			url:'<?php echo base_url();?>site/landing/get_password',
			data:{email:email},
			success:function(response){	
				$('#signin_password').val(response.trim());
			}
		});
	}else{
