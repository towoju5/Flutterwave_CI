...
<?php } else {?>
		...
		<!--<input type="text" style="width: 85%;" class="auto-tet" placeholder="<?php if($this->lang->line('Where_are') != '') { echo stripslashes($this->lang->line('Where_are')); } else echo "Where?";?>" id="autocomplete">-->
      ...
      <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="nav-collapse navbar-collapse my-nav">
				...
				<li ><a href="explore_listing"  class="request-trip" ><?php if($this->lang->line('properites') != '') { echo stripslashes($this->lang->line('properites')); } else echo "Rental Properites";?></a></li>
				<li><a href="explore_experience"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Homes  and Land For Sale"; ?></a></li>
...
<li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('create_properties') != '') { echo stripslashes($this->lang->line('create_properties')); } else echo "Rent Out Your Property or Space"; ?></a></li>
<li><a href="javascript:void(0);" class="reg-popup"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Create Home or Land For Sale"; ?>
						</a></li>
	  ...
	  <?php //} ?>
                ...
                <ul class="showlist3" >
                    ...
                    ?>
                    <li><a href="<?php echo base_url();?>experience/all"><?php if($this->lang->line('my_experience_list') != '') { echo stripslashes($this->lang->line('my_experience_list')); } else echo "Properties For Sale List"; ?></a></li>
...
<!--new-->
                     ...
                     <li class="sidebar-item"><a class="sidebar-anchor" href="<?php echo base_url();?>experience/all"><?php if($this->lang->line('header_experience') != '') { echo stripslashes($this->lang->line('header_experience')); } else echo "Porperty For Sale List"; ?></a></li>
<!--new-->
