      ...
      <div id="tab_default_1" class="tab-pane active">
			  ...
			  ?>
               <ul class="reviw-loop"> <?php
				...
				<!--
				<li>
				<div class="img-lefts"><img src="<?php echo $useImg; ?>" width="100" /></div>
				...
				<span class="review_img" style="margin:0px;" ><img class="review_st" style="width:<?php echo $review->total_review * 20?>%"></span></div>
				</li> -->
				...
				<br>
				<span class="by-area" id="exp_sub" style="padding-left: 0px;"><?php if($this->lang->line('by') != '') { echo stripslashes($this->lang->line('by')); } else echo "by";?> 
				...
				<div class="rigtf-lefts exp_rvw" style="text-align:justify;">
				<div>
				<span class="review_img" style="margin:0px;"><img class="review_st" style=" padding:10px 0px; width:<?php echo $review->total_review * 20?>%"></span>
