...
<?php //echo "<pre>"; print_r($ReviewDetails->result_array()); die;?>
	 ...
	 */?>
	 ...
	 <h3><?php //if($this->lang->line('Past_Dispute') != '') { echo stripslashes($this->lang->line('Past_Dispute')); } else echo "Past Dispute";?>
	  ...
	  Cancelled experience booking of your experience.
		   ...
		   //print_r($Canceldisputebooking->result());
...
function cancelbookingdispute(id,booking_no,cancel_id){
    ...
    $.ajax({
        ...
        url:baseURL+'site/experience/Cancel_Book_experience',
        ...
        success:function(response){
          ...
          if(response.trim()=='success')
           ...
           window.location.href = baseURL+'experience-cancel_booking_dispute';
        }
...
function rejectBooking(id,booking_no,cancel_id){
  //alert('rej');
   $.ajax({
        ...
        url:baseURL+'site/experience/rejectBooking_experience',
