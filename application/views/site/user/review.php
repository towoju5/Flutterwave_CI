...
<?php //echo "<pre>"; print_r($ReviewDetails->result_array()); die;?>
	  ...
	  <form action="<?php echo base_url().'display-review';?>" method='POST' id='search_result_form'>
               ...
               <ul class="reviw-loop"> <?php
				...
				<?php 
				  ...
				  if($this->lang->line('no_past_reviews') != '')
							{ 
								$no_past = stripslashes($this->lang->line('no_past_reviews')); 
							} 
							else
							{
								$no_past = "No past reviews found!";
							}
