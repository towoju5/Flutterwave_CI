...
<?php if($flash_data != '') { ?>
 ...
 -->              </ul>
          ...
          <b><?php if($this->lang->line('Product_details_not_available') != '') { echo stripslashes($this->lang->line('Product_details_not_available')); } else echo "Product details not available";?>
</b>
          <?php }else {?>
        ...
        <div id="infscr-loading" style="display:none">
          ...
          <span class="loading"><?php if($this->lang->line('Loading') != '') { echo stripslashes($this->lang->line('Loading')); } else echo "Loading";?>...</span> </div>
      </div>
      <aside id="sidebar">
        ...
        ?>
          ...
          <?php if ($loginCheck != '' && $userDetails->row()->id == $userProfileDetails->row()->id){?>
           	<a title="<?php if($this->lang->line('Edit Profile Image') != '') { echo stripslashes($this->lang->line('Edit Profile Image')); } else echo "Edit Profile Image";?>" style="display: none;" class="btn-edit tooltip" onclick="$.dialog('change-photo').open();return false;" href="#">
          	<i class="ic-pen"></i>
          ...
          ?>
            <li><a href="<?php echo $fb_link;?>" target="_blank"><span class="icon ic-fb"></span> <?php if($this->lang->line('Facebook') != '') { echo stripslashes($this->lang->line('Facebook')); } else echo "Facebook";?></a></li>
            <li><a href="<?php echo $tw_link;?>" target="_blank"><span class="icon ic-tw"></span> <?php if($this->lang->line('Twitter') != '') { echo stripslashes($this->lang->line('Twitter')); } else echo "Twitter";?></a></li>
            <li><a href="<?php echo $go_link;?>" target="_blank"><span class="icon ic-gg"></span> <?php if($this->lang->line('Twitter') != '') { echo stripslashes($this->lang->line('Twitter')); } else echo "Twitter";?></a></li>
          </ul>
<!--           <a href="#" class="rank" onMouseOver="var x = $(this).position();$(this).parents('.user-cover').find('.tooltip-pop').css('left',x.left+($(this).width()/2)-95+'px').show();" onMouseOut="$(this).parents('.user-cover').find('.tooltip-pop').hide();">85 rank</a>
      -->     <div class="tooltip-pop"><b><?php echo $siteTitle;?> <?php if($this->lang->line('Rank') != '') { echo stripslashes($this->lang->line('Rank')); } else echo "Rank";?></b> <span><?php if($this->lang->line('Your rank is a real-time popularity score of the things you ve added to') != '') { echo stripslashes($this->lang->line('Your rank is a real-time popularity score of the things you ve added to')); } else echo "Your rank is a real-time popularity score of the things you've added to";?>
 <?php echo $siteTitle;?>.</span> <span><?php if($this->lang->line('The more popular your things, the higher your rank') != '') { echo stripslashes($this->lang->line('The more popular your things, the higher your rank')); } else echo "The more popular your things, the higher your rank";?>.</span></div>
          <ul class="followers">
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/followers" ><b><?php echo $userProfileDetails->row()->followers_count;?></b> <small><?php if($this->lang->line('Followers') != '') { echo stripslashes($this->lang->line('Followers')); } else echo "Followers";?></small></a></li>
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/following" ><b><?php echo $userProfileDetails->row()->following_count;?></b> <small><?php if($this->lang->line('Following') != '') { echo stripslashes($this->lang->line('Following')); } else echo "Following";?></small></a></li>
          </ul>
          <div class="user-control">
          <?php if ($loginCheck == $userProfileDetails->row()->id){?>
            <div class="relation"> <a href="settings" class="edit-profile btn"><?php if($this->lang->line('EditProfile') != '') { echo stripslashes($this->lang->line('EditProfile')); } else echo "Edit Profile";?></a> </div>
          <?php }else {?>
            <div class="relation"> <a href="#" uid="<?php echo $userProfileDetails->row()->id;?>" <?php if ($loginCheck==''){?>require_login="true"<?php }?> class="follow-user-link follow-link <?php echo $followClass;?>"><i class="icon"></i><?php if($this->lang->line('Follow') != '') { echo stripslashes($this->lang->line('Follow')); } else echo "Follow";?></a> </div>
          <?php }?>
            <div class="setting">
              ...
              <div class="menu-content">
                <ul>
                   <li><a href="<?php echo base_url();?>site/feed/user/<?php echo $userProfileDetails->row()->user_name;?>" target="_blank"><?php if($this->lang->line('RSS_Feed') != '') { echo stripslashes($this->lang->line('RSS_Feed')); } else echo "RSS Feed";?></a></li>
                   <li><a href="<?php echo base_url();?>user/<?php echo $userProfileDetails->row()->user_name;?>" username="<?php echo $userProfileDetails->row()->user_name;?>" txt="Check out <?php echo $userProfileDetails->row()->full_name;?>'s profile!" <?php if ($loginCheck == ''){?>require_login="true"<?php }?> class="btn-user-share"><?php if($this->lang->line('Share_Profile') != '') { echo stripslashes($this->lang->line('Share_Profile')); } else echo "Share Profile";?></a></li>
                </ul>
              </div>
            </div>
          </div>
...
<!--         
 ...
 --> 
        ...
        <div class="wrapper activity">
          <h3 class="stit"><?php if($this->lang->line('Recent_Activity') != '') { echo stripslashes($this->lang->line('Recent_Activity')); } else echo "Recent Activity";?></h3>
 ...
 //         	$actTime = humanTiming($activityTime) . " ago" ;
    ...
    <?php 
     ...
     ?>
    <a href="#header" id="scroll-to-top"><span><?php if($this->lang->line('Jump_to_top') != '') { echo stripslashes($this->lang->line('Jump_to_top')); } else echo "Jump to top";?></span></a> </div>
  <!-- / container -->
</div>
