                       ...
                       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="member_ship" id="productListTable">
                     		<thead>
 							 <tr height="40px"><!--<td width="15%" style="background:#f5f5f5;" ><strong>Status</strong></td>-->
   							 <td width="10%" style="background:#f5f5f5;"><strong><?php if($this->lang->line('DatesandLocation') != '') { echo stripslashes($this->lang->line('DatesandLocation')); } else echo "Dates and Location";?></strong></td>
   							 <td width="30%" style="background:#f5f5f5;" ><strong><?php if($this->lang->line('Guest') != '') { echo stripslashes($this->lang->line('Guest')); } else echo "Guest";?></strong></td>
							...
							<p class="no_listings">
                 				<?php if($this->lang->line('Youhavenoreservations') != '') { echo stripslashes($this->lang->line('Youhavenoreservations')); } else echo "You have no reservations";?>.<br>
                       			<a href="<?php echo base_url()."list_space"; ?>"><?php echo base_url()."list_space"; ?>"><?php if($this->lang->line('Createanewisting') != '') { echo stripslashes($this->lang->line('Createanewisting')); } else echo "Create a new listing";?></a>.
                  			 </p>
							<?php 
							}
							?>
