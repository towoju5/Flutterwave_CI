      ...
      <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="nav-collapse navbar-collapse my-nav">
				...
				<li class="browse_div2 bocom-host" id="broswe_box1"><a <?php if ($loginCheck == ''){?> href="javascript:void(0);" class="login-popup ren-sp" <?php } else { ?> href="explore_experience" <?php } ?>  class="request-trip" ><?php if($this->lang->line('experience_on_header') != '') { echo stripslashes($this->lang->line('experience_on_header')); } else echo "Experience";?><i class="caret"></i></a>				<ul class="showlist3" >						<span class="ard"></span>						 <li ><a href="explore_listing"  class="request-trip" ><?php if($this->lang->line('properites') != '') { echo stripslashes($this->lang->line('properites')); } else echo "Properites";?></a></li>						<li><a href="explore_experience"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Land and Houses For Sale"; ?></a></li>					</ul>				</li>
				...
				<li class="browse_div2 bocom-host" id="broswe_box1">
				 ...
				 <?php if($this->lang->line('Become_Host') != '') { echo stripslashes($this->lang->line('Become_Host')); } else echo "Become a Host	";?><i class="caret"></i></a>             
					<ul class="showlist3" >
						<span class="ard"></span>
						<li ><a href="explore_listing"  class="request-trip" ><?php if($this->lang->line('properites') != '') { echo stripslashes($this->lang->line('properites')); } else echo "Properites";?></a></li>						<li><a href="explore_experience"><?php if($this->lang->line('experiences_adventures') != '') { echo stripslashes($this->lang->line('experiences_adventures')); } else echo "Experiences & Adventures"; ?></a></li>
					</ul>
