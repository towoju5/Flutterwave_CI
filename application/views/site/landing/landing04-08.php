...
<?php } ?>
    ...
    </div>	<div class="relative-holder"><div class="searching-section"> <div class="container">    <!--This is for mobile view  doesnot disply in normal view only for mobil --><!-- WILL DISPLAY ONLY ON MODILE FOE RESPONSIVE > STATIC start--><div class="searct-sechs mobile-display ">   <a class="mobile-selecbox" href="#success" data-toggle="modal"><input class="search-text" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where to?"; ?>" type="text"><input class="sbt-btn" value="Search" type="submit"></a>    <!-- Modal -->        <!-- Modal -->    <div class="modal fade banerpop" id="success" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">        <div class="modal-dialog">            <div class="modal-content">                <div class="modal-header modal-header-success">                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>                </div>                <div class="modal-body">                      <form  class="mobilform" method="get" action="property" id="property_search_form_mob" accept-charset="UTF-8" >					  						<input name="city" id="autocompleteNew" class="where" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where to?"; ?>"  type="text"  >						<div class="LocationInput__error"><span class="city_error_mob"></span></div>					<input type="text" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check In";?>" value="<?php if($_GET['datefrom']!='')echo $_GET['datefrom'];else if($_POST['datefrom'])echo $_POST['datefrom']; ?>" id="datepicker_mob" name="datefrom" readonly style="cursor:pointer;"  ><input class="chek-in to_date" type="text" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out";?>"  id="datepicker_mob1" value="<?php if($_GET['dateto']!='')echo $_GET['dateto'];else if($_POST['dateto'])echo $_POST['dateto']; ?>" name="dateto" readonly style="cursor:pointer;" ><?php /*                        <input  name="datefrom" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in"; ?>" type="text" contenteditable="false">                        <input  name="dateto" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out"; ?>" type="text" contenteditable="false">*/ ?>                         <!--<input name="guests" class="guest" placeholder="Number of guest" type="text">-->                            <?php if($accommodates !='' && count($accommodates)){     ?>                        <select name="guests" class="home_select"><span><i class="caret"></i></span>                         <?php foreach($accommodates as $accommodate) {                        if($accommodate==1){  ?>                         <option value="<?php echo $accommodate;?>"><?php echo $accommodate.' '?><?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guest";?><i class="caret" style="color:#000"></i></option>                         <?php } else { ?>                         <option value="<?php echo $accommodate;?>">                         <?php echo $accommodate.' ';?><?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guest";?></option>                         <?php } ?>                         <?php }?>                         </select>                        <?php } ?>                         <input class="fom-subm" value="<?php if($this->lang->line('search') != '') { echo stripslashes($this->lang->line('search')); } else echo "Search"; ?>" type="button" onclick="property_search_mob();">						                  </form>                </div>            </div><!-- /.modal-content -->        </div><!-- /.modal-dialog -->    </div><!-- /.modal -->    <!-- Modal --></div><!-- WILL DISPLAY ONLY ON MODILE FOE RESPONSIVE >    end--><!--This is for mobile view  END --><div class="heading_home"><p class="banner_text"><span class="banner_text"><?php if($this->lang->line('Homestay') != '') { echo stripslashes($this->lang->line('Homestay'));  } else { "HomestayDNN";} ?></span> <?php if($this->lang->line('Book_unique_homes') != '') { echo stripslashes($this->lang->line('Book_unique_homes'));  } else { "Book unique homes and";} ?><br><?php if($this->lang->line('experience_a_city') != '') { echo stripslashes($this->lang->line('experience_a_city'));  } else { "experience a city like a local.";} ?></p></div><div><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a></div>                 <form  class="webform" method="get" action="property" id="property_search_form" accept-charset="UTF-8"><div class="SearchForm__row">                        <div class="search-sec srch_whr">						<p><?php if($this->lang->line('Where') != '') { echo stripslashes($this->lang->line('Where')); } else echo "Where?"; ?></p>						<input name="city" id="autocompleteNewMobile" class="where" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where do you want to go?"; ?>" value=""  type="text"  ></div>						 <div class="LocationInput__error"><span class="city_error"></span></div>                        <?php /*                        <input  name="datefrom" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in"; ?>" type="text" contenteditable="false">						<input  name="dateto" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out"; ?>" type="text" contenteditable="false">*/ ?>		 <div class="search-sec srch_whn">							<p><?php if($this->lang->line('When') != '') { echo stripslashes($this->lang->line('When')); } else echo "When?"; ?></p>					<input type="text" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in";?>" value="<?php if($_GET['datefrom']!='')echo $_GET['datefrom'];else if($_POST['datefrom'])echo $_POST['datefrom']; ?>" id="datepicker" name="datefrom" readonly style="cursor:pointer;" /><input type="text" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out";?>"  id="datepicker1" value="<?php if($_GET['dateto']!='')echo $_GET['dateto'];else if($_POST['dateto'])echo $_POST['dateto']; ?>" name="dateto" readonly style="cursor:pointer;" /></div>                         <!--<input name="guests" class="guest" placeholder="Number of guest" type="text">-->                            <?php if($accommodates !='' && count($accommodates)){  ?><div class="search-sec-gust"><div class="search-sec-gust-in">						<p><?php if($this->lang->line('Guest') != '') { echo stripslashes($this->lang->line('Guest')); } else echo "Guest?"; ?></p>	                        <select name="guests" class="home_select"><span><i class="caret"></i></span>                         <?php foreach($accommodates as $accommodate) {                        if($accommodate==1){                         ?>                         <option value="<?php echo $accommodate;?>"><?php echo $accommodate.' '?> <?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest_s')); } else echo "Guest";?><i class="caret" style="color:#000"></i></option>                         <?php } else { ?>                         <option value="<?php echo $accommodate;?>">                         <?php echo $accommodate.' ';?> <?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guests";?></option>                         <?php } ?>                         <?php }?>                         </select>                        <?php } ?></div>                     <input class="fom-subm" value="<?php if($this->lang->line('search') != '') { echo stripslashes($this->lang->line('search')); } else echo "Search"; ?>" type="button" onclick="property_search();">					 </div>    </div><input type="hidden" name="language_code" id="language_code" value="<?php echo $this->session->userdata('language_code'); ?>" >                 </form><div class="botm_tb"><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a><a href="#" class="btn tab default">Property</a></div>				                          <span id="city_warn"></span>                       </div>                  </div></div>
</div>
...
</section><section id="mobile_version" style="display:none"><div class="relative-holder"><div class="searching-section"> <div class="container">    <!--This is for mobile view  doesnot disply in normal view only for mobil --><!-- WILL DISPLAY ONLY ON MODILE FOE RESPONSIVE > STATIC start--><div class="searct-sechs mobile-display ">   <a class="mobile-selecbox" href="#success" data-toggle="modal"><input class="search-text" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where to?"; ?>" type="text"><input class="sbt-btn" value="Search" type="submit"></a>    <!-- Modal -->        <!-- Modal -->    <div class="modal fade banerpop" id="success" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">        <div class="modal-dialog">            <div class="modal-content">                <div class="modal-header modal-header-success">                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>                </div>                <div class="modal-body">                      <form  class="mobilform" method="get" action="property" id="property_search_form_mob" accept-charset="UTF-8" >					  						<input name="city" id="autocompleteNew" class="where" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where to?"; ?>"  type="text"  >						<div class="LocationInput__error"><span class="city_error_mob"></span></div>					<input type="text" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check In";?>" value="<?php if($_GET['datefrom']!='')echo $_GET['datefrom'];else if($_POST['datefrom'])echo $_POST['datefrom']; ?>" id="datepicker_mob" name="datefrom" readonly style="cursor:pointer;"  ><input class="chek-in to_date" type="text" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out";?>"  id="datepicker_mob1" value="<?php if($_GET['dateto']!='')echo $_GET['dateto'];else if($_POST['dateto'])echo $_POST['dateto']; ?>" name="dateto" readonly style="cursor:pointer;" ><?php /*                        <input  name="datefrom" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in"; ?>" type="text" contenteditable="false">                        <input  name="dateto" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out"; ?>" type="text" contenteditable="false">*/ ?>                         <!--<input name="guests" class="guest" placeholder="Number of guest" type="text">-->                            <?php if($accommodates !='' && count($accommodates)){     ?>                        <select name="guests" class="home_select"><span><i class="caret"></i></span>                         <?php foreach($accommodates as $accommodate) {                        if($accommodate==1){  ?>                         <option value="<?php echo $accommodate;?>"><?php echo $accommodate.' '?><?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guest";?><i class="caret" style="color:#000"></i></option>                         <?php } else { ?>                         <option value="<?php echo $accommodate;?>">                         <?php echo $accommodate.' ';?><?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guest";?></option>                         <?php } ?>                         <?php }?>                         </select>                        <?php } ?>                         <input class="fom-subm" value="<?php if($this->lang->line('search') != '') { echo stripslashes($this->lang->line('search')); } else echo "Search"; ?>" type="button" onclick="property_search_mob();">						                  </form>                </div>            </div><!-- /.modal-content -->        </div><!-- /.modal-dialog -->    </div><!-- /.modal -->    <!-- Modal --></div><!-- WILL DISPLAY ONLY ON MODILE FOE RESPONSIVE >    end--><!--This is for mobile view  END --><div class="heading_home"><p><span><?php if($this->lang->line('Homestay') != '') { echo stripslashes($this->lang->line('Homestay'));  } else { "HomestayDNN";} ?></span> <?php if($this->lang->line('Book_unique_homes') != '') { echo stripslashes($this->lang->line('Book_unique_homes'));  } else { "Book unique homes and";} ?><br><?php if($this->lang->line('experience_a_city') != '') { echo stripslashes($this->lang->line('experience_a_city'));  } else { "experience a city like a local.";} ?></p></div><div class="col-md-12 mic" id="col_marg" style="margin-left:-15px;">            <div id="news-slider1" class="owl-carousel topmtab" style="opacity: 1; display: block;">    			<!-- Slide 1--><div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property1</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property2</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property3</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property4</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property5</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property6</a>                                             </div>				<div class="post-slide">                   <a href="#" class="btn tab default owl-item">Property7</a>                                             </div>		</div>    </div>	                 <form  class="webform mobweform" method="get" action="property" id="property_search_form" accept-charset="UTF-8"><div class="SearchForm__row">                        <div class="search-sec srch_whr">						<p><?php if($this->lang->line('Where') != '') { echo stripslashes($this->lang->line('Where')); } else echo "Where?"; ?></p>						<input name="city" id="autocompleteNewMobile" class="where" placeholder="<?php if($this->lang->line('search_where') != '') { echo stripslashes($this->lang->line('search_where')); } else echo "Where do you want to go?"; ?>" value=""  type="text"  ></div>						 <div class="LocationInput__error"><span class="city_error"></span></div>                        <?php /*                        <input  name="datefrom" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in"; ?>" type="text" contenteditable="false">						<input  name="dateto" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out"; ?>" type="text" contenteditable="false">*/ ?>		 <div class="search-sec srch_whn">							<p><?php if($this->lang->line('When') != '') { echo stripslashes($this->lang->line('When')); } else echo "When?"; ?></p>					<input type="text" class="chek from_date" placeholder="<?php if($this->lang->line('check_in') != '') { echo stripslashes($this->lang->line('check_in')); } else echo "Check in";?>" value="<?php if($_GET['datefrom']!='')echo $_GET['datefrom'];else if($_POST['datefrom'])echo $_POST['datefrom']; ?>" id="datepicker" name="datefrom" readonly style="cursor:pointer;" /><input type="text" class="chek-in to_date" placeholder="<?php if($this->lang->line('check_out') != '') { echo stripslashes($this->lang->line('check_out')); } else echo "Check out";?>"  id="datepicker1" value="<?php if($_GET['dateto']!='')echo $_GET['dateto'];else if($_POST['dateto'])echo $_POST['dateto']; ?>" name="dateto" readonly style="cursor:pointer;" /></div>                         <!--<input name="guests" class="guest" placeholder="Number of guest" type="text">-->                            <?php if($accommodates !='' && count($accommodates)){  ?><div class="search-sec-gust"><div class="search-sec-gust-in">						<p><?php if($this->lang->line('Guest') != '') { echo stripslashes($this->lang->line('Guest')); } else echo "Guest?"; ?></p>	                        <select name="guests" class="home_select"><span><i class="caret"></i></span>                         <?php foreach($accommodates as $accommodate) {                        if($accommodate==1){                         ?>                         <option value="<?php echo $accommodate;?>"><?php echo $accommodate.' '?> <?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest_s')); } else echo "Guest";?><i class="caret" style="color:#000"></i></option>                         <?php } else { ?>                         <option value="<?php echo $accommodate;?>">                         <?php echo $accommodate.' ';?> <?php if($this->lang->line('guest') != '') { echo stripslashes($this->lang->line('guest')); } else echo "Guests";?></option>                         <?php } ?>                         <?php }?>                         </select>                        <?php } ?></div>                     <input class="fom-subm" value="<?php if($this->lang->line('search') != '') { echo stripslashes($this->lang->line('search')); } else echo "Search"; ?>" type="button" onclick="property_search();">					 </div>    </div><input type="hidden" name="language_code" id="language_code" value="<?php echo $this->session->userdata('language_code'); ?>" >                 </form>								                          <span id="city_warn"></span>                       </div>                  </div></div></section>
<div class="clear"></div>
