...
?>
<div id="content">
		<!-- <br><center><a href="admin/newsletter/display_subscriber_newsletter"><button type="submit" id="add_btn" class="btn_small btn_blue" tabindex="9"><span>Subscriber Template List</span></button></a></center> -->
