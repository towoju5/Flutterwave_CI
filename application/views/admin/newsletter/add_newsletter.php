					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="news_subscriber" style="" id="news_sub" value="" type="radio" checked /> Normal
									
									<input name="news_subscriber" style="" id="news_subr" value="Yes" type="radio" /> Subscribers
