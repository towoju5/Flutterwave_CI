						...
						<tr>
							...
							<td class="center  tr_select">
								...
								if($row->default_lang=='Default'){
									?>
									<img src="images/checked.png" class="tip_top" original-title="Default Site Language">
									<?php
								}
								?> 
							</td>
							...
							<td class="center">
							<input type="text" name="language_order"  onchange="UpdateLangOrder(this,<?php echo $row->id; ?>,'language_order')"  maxlength="2" onkeypress="return check_for_num(event)" value="<?php echo $row->language_order; ?>"><br>
							...
							if($row->status == 'Active' && $row->default_lang!='Default') {?>
								<span><a class="action-icons c-approve" href="admin/multilanguage/default_language/<?php echo $row->id;?>" title="Make as Default">Default</a></span>
							<?php }?>
