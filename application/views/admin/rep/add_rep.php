					...
					?>
							...
							<li>
								<div class="form_grid_12">
                                   ...
                                   <input type="hidden" name="rep_type" id="rep_type_representative" value="Representative"  required checked="checked" />
									</div> 
								</div>
							</li>
							...
							<li id='repcode' >
								<div class="form_grid_12">
									...
									<div class="form_input">
					<input name="rep_Code" id="rep_Code" type="text" tabindex="" class="required large tipTop"
value="<?php $gt='REP'; 
$n=time();
 echo $gt.$n; ?>" readonly />
									</div>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="email" id="email" type="text" tabindex="1" class="required large tipTop" title="Please enter the email address"  placeholder="Please enter the email address" onChange="check_rep_email(this.value);"/>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="name" id="name" type="text" tabindex="2" class="required large tipTop" title="Please enter the user name" placeholder="Please enter the user name"/> <label id="name_error" style="color:#f00;display:none;" class="error">Numbers are not allowed</label>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="admin_name" id="admin_name" type="text" tabindex="3" class="required large tipTop" title="Please enter the login name" placeholder="Please enter the login name"/> <label id="admin_name_error" style="color:#f00;display:none;" class="error">Numbers are not allowed</label>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="admin_password" id="admin_password" type="password" tabindex="4" class="required large tipTop" title="Please enter the password" placeholder="Please enter the password"/>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="confirm_password" id="confirm_password" type="password" tabindex="5" class="required large tipTop" placeholder="Please re-type the above password" title="Please re-type the above password"/>
									</div>
								</div>
								</li>
		...
		<input class="caseSeeker" type="checkbox" id="checkbox" name="<?php echo $subAdmin.'[]';?>" id="<?php echo $subAdmin.'[]';?>" 
		value="<?php echo $j;?>" />
								        		</span>
								        	</td>
											<?php } ?>
								...
								<div class="form_grid_12">
									<label class="field_title" for="site_contact_mail"></label>
									<div id="uniform-undefined" class="form_input checker focus">
						<span class="" style="float:left;"><input type="checkbox" class="checkbox" id="selectallseeker" /></span><label style="float:left;margin:5px;">Select all 4</label>
									</div>
								</div>
								<div style="margin-top: 20px;"></div>
								<div class="form_grid_12">
