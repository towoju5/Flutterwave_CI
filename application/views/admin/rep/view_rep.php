				...
				<div class="widget_wrap">
					...
					?>
	 						<ul>
								...
								<input type="hidden" value="<?php echo $rep_details->row()->id;?>" name="subadminid" />
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/rep/display_rep_list" class="tipLeft" title="Back to representative list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
