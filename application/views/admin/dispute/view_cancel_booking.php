	 						...
	 						<ul>
                               ...
                               <li>
								...
								<div style="margin-left:340px;">
									<a href='<?php echo base_url()."admin/dispute/Cancel_Book/".$review_details->row()->id.'/'.$review_details->row()->booking_no.'/'.$review_details->row()->cancel_status;?>'><button type="button" class="btn_small btn_blue" tabindex="4"><span>Accept</span></button></a>
                               ...
                               <li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/dispute/cancel_booking_list" class="tipLeft" title="Go to Cancel Booking list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
							</li>
							</ul>
