					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center">
								  ...
								  <?php //echo $row->total.' prod '; 
								  //echo $row->currency_code.' admin '.$admin_currency_code;

								  //echo $admin_currency_symbol.' '. AdminCurrencyValue($row->product_id ,$row->total);
							...
							<td class="center">
                                ...
                                <div id="Plusclose<?php echo $row->id;?>" style="display:none;"><img src="images/details_close.png" onclick="viewcloseorders();" /></div>-->
                           		<a href="admin/experience_order/order_review/<?php echo $row->dealCodeNumber;?>" class="tipTop" title="View details"><span class="action-icons c-suspend" style="cursor:pointer;"></span></a>
<?php /*$atts = array(
              'width'      => '1100',
              'height'     => '700',
              'scrollbars' => '1',
