					...
					<div class="widget_content">
						...
						<tr>
                           ...
                           <!-- <td class="center">
							...
							<td class="center">
								<?php //echo $row->price." ".$row->currency_code_host;?>
								<?php echo $row->price." ".$row->hosted_currency;?>
							</td>
							<td class="center">
								 <?php 
							...
							<td class="center">
								...
								/* if($admin_currency_code!=$row->currency_code_host){
									...
									echo $admin_currency_symbol.' '.customised_currency_conversion($unitPerCurrencyHost,$row->hosting_price);
								}else
									echo $admin_currency_symbol." ".$row->hosting_price; */
