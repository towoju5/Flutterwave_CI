			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
						<?php if ($allPrev == '1' || in_array('2', $currencyList)){?>
							<div class="btn_30_light" style="height: 29px;">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center  tr_select">
                             ...
                             <td class="center tr_select ">
								...
								if($row->default_currency=='Yes'){
									?>
									 <img src="images/checked.png" class="tip_top" original-title="Default Site Currency">
									<?php
								}
								?> 
							</td>
							...
							if($row->status == 'Active' && $row->default_currency!='Yes') {?>
								<span><a class="action-icons c-approve" href="admin/currency/make_default/<?php echo $row->id;?>" title="Make as Default">Default</a></span>
							<?php }?>
						...
						<tr>
                            ...
                            <th class="center" title="Click to sort" style="display:none;">
								Currency Rate
							</th> 
                            <th>
								Currency Type
