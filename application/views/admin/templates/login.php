		...
		<div class="login_header blue_lgel">
			<ul class="login_branding">
				...
				<div class="logo_small">
					<img width="50%" src="images/logo/<?php echo $this->config->item('logo_image');?>">
				</div>
				<span></span>
				</li>
		...
		if (!$this->data['demoserverChk']){ ?>
			<div class="login_form">
				...
				<ul>
					...
					<!---<input class="login-scroll" name="admin_name" value="admin"  type="text" style="border: 1px solid #b9b2b2;">-->
					<input class="login-scroll" name="admin_name"  id="admin_name_id" value=""  type="text" style="border: 1px solid #b9b2b2;">
					</li>
					<li class="login_pass tipTop" title="Please enter your password">
					<label>Password:</label>
					<!--<input class="login-scroll" name="admin_password" type="password" style="border: 1px solid #b9b2b2;" value="admin123" >-->
					<input class="login-scroll" name="admin_password" id="admin_password_id" type="password" style="border: 1px solid #b9b2b2;" value="" >
					</li>
				</ul>
			</div>
			<ul class="login_opt_link">
				...
				<input name="remember" class="rem_me"   id="remember_me_chk" type="checkbox" >
				Remember Me
				<!--onclick="setInLocal()"  -->
				</li>
			...
			<center><input class="log-butt" name="" value="Login" type="submit"></center>
