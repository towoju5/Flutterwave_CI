		...
		<div class="header_left">
			...
			<div id="responsive_mnu">
				...
				<ul class="acitem" <?php if($currentUrl=='adminlogin' || $currentUrl=='sitemapcreate'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					<li><a href="admin/adminlogin/display_admin_list" <?php if($currentPage=='display_admin_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Admin Users List</a></li>
			...
			<div id="user_nav" <?php if ($allPrev != '1'){?>style="width: 250px;"<?php }?>>
				<ul>
					...
					<li class="user_info">
						...
						<span>
							<a target="_blank" class="tipBot" title=""><?php echo $this->session->userdata('fc_session_admin_name');?> <?php //echo $this->session->userdata('fc_session_admin_rep_code');?></a> &#124; 
