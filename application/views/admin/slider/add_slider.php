					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="slider_title" id="slider_title" type="text" tabindex="2" class="required large tipTop" title="Please enter the slider title"/>
										 <span id="slider_title_valid" style="color:#f00;display:none;">Special Characters Not Allowed</span>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="slider_link" id="slider_link" type="url" tabindex="2" class="required large tipTop" title="Please enter the slider link"/>
									</div>
								</div>
								</li>
                                <li>
