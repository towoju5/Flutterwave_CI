       ...
       <span style="float:right;">	User Name : <?php echo $this->session->userdata('fc_session_admin_name'); ?><br>
       	...
       	<br>
			...
			?>
                <div class="user_s" style="float: left !important; margin-right: 8px;">
					<div class="block_label">
						Total Guest<span><?php echo $totalUserCounts;?></span>
					</div>
				...
				<div class="views_s">
					<div class="block_label">
						Total Property List<span><?php echo $getTotalProductCount_rep;?></span>
					</div>
					<span class="badge_icon bank_sl"></span>
				</div>
				<?php } ?>
				<div class="views_s">
					<div class="block_label">
						Total Host<span><?php echo $getTotalSellerCount;?></span>
					</div>
					<span class="badge_icon hostdash"></span>
					</div>
					<!--<div class="activities_s">
					<div class="block_label">
            ...
            <div class="grid_6">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<?php $totalguho = $getTotalSellerCount + $totalUserCounts; ?>
							<h4>Guest & Host Count <?php //echo $totalguho;?></h4>
							<table>
							<tbody>
							<tr>
								<td>
			...
			<div class="grid_6">
				<div class="widget_wrap">
					<div class="widget_top">
						<span class="h_icon chart"></span>
						<h6>Property</h6>
					</div>
					<div class="widget_content">
						<div class="stat_block">
						
							<h4>Property Count <?php //echo $getTotalProductCount;?></h4>
							<table>
							<tbody>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<?php echo $ThisMonthPropertyCount;?>
								</td>
							...
							<tr>
								...
								<td>
									<?php echo $getLastYearProertyCount;?>
								</td>
