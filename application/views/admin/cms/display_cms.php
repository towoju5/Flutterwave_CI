...
<!-- 							<th class="tip_top" title="Click to sort">
 ...
 -->							<th class="tip_top" title="Click to sort">
						...
						<tr>
							...
							<?php   if( $row->seourl != "privacy-policy" && $row->seourl !="terms-of-service" && $row->seourl !=  "cancellation-policy"  ) { ?>
...
<!-- 							<td class="center">
 ...
 -->							<td class="center">
					...
					if( $row->seourl != "privacy-policy" && $row->seourl !="terms-of-service" && $row->seourl !=  "cancellation-policy" ) {
							...
							<?php }?>
							<?php if (($allPrev == '1' || in_array('3', $Pages)) && ( $row->seourl != "privacy-policy" && $row->seourl !="terms-of-service" && $row->seourl !=  "cancellation-policy" )){?>	
