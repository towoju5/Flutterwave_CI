...
//						}
                ...
                <div class="widget_content">
                    ...
                    <tbody>
                      ...
                      <?php 
						...
						<tr>
                        <td class="center tr_select " colspan="2">No Images uploaded...!</td>
			...
			<?php } ?>
              ...
              <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input" ><a href="admin/product/display_product_list" class="tipLeft" title="Go to Property List"><span class="badge_style b_done">Back</span></a> </div> </div>
                      </li>
            </ul>
          </div>
 ...
 <div id="tab5">
            ...
            <ul>
			 ...
			 // foreach ($listTypeValuesShow->result() as $values){
...
<!--<label class="field_title" for="order_email"><?php //echo $Name; ?></label>-->
             <label class="field_title" for="order_email"><?php echo $listTypeValuesShow->row()->labelname; ?></label>
			  ...
			  ?>
			   ...
			   <!--minimum stay showed from fc_liting_types-->
			    <?php
			 ...
			 <li>
                <div class="form_grid_12">
                  <label class="field_title" for="order_email"><?php  echo $get_minimumStay->row()->labelname; ?></label>
                  <div class="form_input">
                  <?php  
				  $miminum_stay_id = $product_details->row()->minimum_stay; 
				  $listchildValues_minimum = $this->product_model->get_all_details('fc_listing_child',array('id'=>$miminum_stay_id));
			...
			<!-- <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                  <?php /*  if($listing_Name == 'minimum stay'){ 
				  $miminum_stay_id = $product_details->row()->minimum_stay; 
				  $listchildValues_minimum = $this->product_model->get_all_details('fc_listing_child',array('id'=>$miminum_stay_id));
