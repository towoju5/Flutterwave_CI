		...
		<div class="grid_container">
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						$attributes = array('class' => 'form_container left_label', 'id' => 'edituser_form','accept-charset'=>'UTF-8');
					   ...
					   <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="coupon_name" id="coupon_name" type="text" tabindex="1" class="required small tipTop" title="Please Enter the Coupon Name" value="<?php echo $couponcard_details->row()->coupon_name;?>"/><span id="coupon_name_valid" style="color:#f00;display:none;">Only Characters are allowed!</span>
									</div>
								</div>
								</li>
                      	<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="code" id="code" type="text" tabindex="2" class="required small tipTop" title="Please Enter the Coupon Code" value="<?php echo $couponcard_details->row()->code;?>" readonly />
									</div>
								</div>
								</li>
                      	<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="quantity" id="quantity" type="text" tabindex="3" class="required small tipTop" title="Please Enter max no of coupons applied count from the customer while booking" value="<?php echo $couponcard_details->row()->quantity;?>"/><span id="quantity_valid" style="color:#f00;display:none;"> Only Numbers are allowed!</span>
									</div>
								</div>
								</li>
						<!-- <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="datefrom" id="datefrom" type="text" tabindex="5" class="required small tipTop datepicker" title="Please select the From date" value="<?php echo $couponcard_details->row()->datefrom;?>" />
									</div>
								</div>
								</li>
						<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="dateto" id="dateto" type="text" tabindex="6" class="required small tipTop datepicker" title="Please select the End date" value="<?php echo $couponcard_details->row()->dateto;?>" />
									</div>
								</div>
								</li>  -->
								<li> 
									<div class="form_grid_12">
										...
										<div class="form_input">
											...
											<input type="hidden" name="datefrom" value="<?php echo $couponcard_details->row()->datefrom;?>" id="fromInput2">
							...
							<li>
								...
								<div class="form_input">
									...
									<input type="hidden" name="dateto" value="<?php echo $couponcard_details->row()->dateto;?>" id="toInput2">
					...
					<ul id="shipping" style="display:block;">
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="price_value" id="price_value" type="text" tabindex="2" class="required small tipTop" title="Please enter the price value" value="<?php echo $couponcard_details->row()->price_value;?>"/><span id="price_value_valid" style="color:#f00;display:none;">Only Numbers are allowed!</span>
									</div>
								</div>
								</li>
                                </ul>
                    ...
                    <ul>
												...
												?>
													...
													<?php	
														...
														foreach ($productDetails[$hostid]->result() as $product) {
															?>
													   		<option value="<?php echo $product->id; ?>" <?php if(in_array($product->id, $selectedProperty)) echo "selected"; ?> ><?php echo $product->product_title.' '.$product->city.','.$product->state;?></option>
								...
								<div class="form_grid_12">
									<div class="form_input">
										...
										<a href="<?php echo base_url().'admin/couponcards/display_couponcards';?>"><button type="button" class="btn_small btn_blue" tabindex="4"><span>Back</span></button></a>
									</div>
								</div>
								</li>
							</ul>
