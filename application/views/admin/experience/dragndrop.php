...
function imageval(){   /*Image size validation*/
	...
	if ((parseInt(width) < 343) || (parseInt(height) < 450)) {
		alert("Image Height and Width should be above 343 * 450 px.");
		return false;
	}
	
	if (width > 3000 || height > 3000) {
	alert("Image Height and Width should have 3000 * 3000 px Below");
	return false;
	}
...
<body>
	<div class="wrap">
		...
		?>
		<p>Photos must be at least (360 x 580px) (W*H) To (3000 X 3000px) (W*H)., Valid formats jpg, png, gif</p>
		<br />
		<br />
