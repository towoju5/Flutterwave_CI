				...
				<div class="widget_wrap">
                    ...
                    ?>  
								...
								<?php if ($result->product_image  != '' && $img=='0') { ?>
								 	<img width="40px" height="40px" src="<?php echo base_url();?>server/php/experience/<?php echo $result->product_image;?>" />
								<?php }else { ?>
									 <img width="40px" height="40px" src="<?php echo base_url();?>server/php/experience/dummyProductImage.jpg" />
								<?php } ?>
								</div>
							</td>
