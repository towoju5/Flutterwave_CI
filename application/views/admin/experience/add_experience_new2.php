    ...
    <div class="grid_12 margin_top_20">
		...
		<!---vertical tab-->
			<div class="tab">
			  ...
			  <button class="tablinks <?php  echo ($basics==0) ? '' : ''; ?> " onclick="openContent(event, 'basics',this)" id="basic_tab" >Basics<?php echo ($basics==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>

			  <button class="tablinks <?php  echo ($language==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'language',this)" id="language_tab" >Language<?php echo ($language==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($organization==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'organization',this)" id="organization_tab" >Organization<?php echo ($organization==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($exp_title==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'exp_title',this)" id="experience_title_tab" >Property Title<?php echo ($exp_title==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($timing==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'timing',this)" id="timing_tab">Timing<?php echo ($timing==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($tagline==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'tagline',this)" id="tagline_tab">Tagline<?php echo ($tagline==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($photos==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'photos',this)" id="photos_tab">Photos<?php echo ($photos==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($what_we_do==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'what_we_do',this)" id="what_we_do_tab">Number of Bathrooms<?php echo ($what_we_do==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($where_will_be==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'where_will_be',this)" id="where_will_be_tab" >Property Size<?php echo ($where_will_be==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($where_will_meet==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'where_will_meet',this)" id="where_will_meet_tab" >Property Location<?php echo ($where_will_meet==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($what_will_provide==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'what_you_will_provide',this)" id="what_you_will_provide_tab" >Property Features<?php echo ($what_will_provide==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($notes==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'notes',this)" id="notes_tab" >Property Description<?php echo ($notes==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  <button class="tablinks <?php  echo ($about_you==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'about_you',this)" id="about_you_tab" >Number of Bedrooms<?php echo ($about_you==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			 
			  
			  <button class="tablinks <?php  echo ($guest_req==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'guest_req',this)" id="guest_req_tab" >Contact Phone Number<?php echo ($guest_req==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($group_size==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'group_size',this)" id="group_size_tab" >Number of Toilets<?php echo ($group_size==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			  <button class="tablinks <?php  echo ($price==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'price_content',this)" id="price_tab" >Price<?php echo ($price==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  <button class="tablinks <?php  echo ($cancel_policy==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'cancel_policy',this)" id="cancel_policy_tab" >Cancellation Policy<?php echo ($cancel_policy==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  
			   <button class="tablinks <?php  echo ($seo==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'seo',this)" id="seo_tab" >SEO<?php echo ($seo==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			</div>

			<div id="basics" class="tabcontent">
			  <h3>Basics 
			  <br><small>Set the basic mandatory fields of your experience.</small>
			  ...
			  <form id="basic_form" name="basic_form" method='post' class="form_container left_label listingInfo">
                    <div class="dashboard_price_right margin_top_20">
						...
						<li>
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Property Type <span class="req">*</span></label>
								<div class="form_input">
							   ...
							   <?php 
								...
								<div class="select margin_bottom_20">
										<select name="experience_type" id="experience_type" class="" onchange="change_date_or_time(this.value)" <?php echo $disab;?> >
											<option value="">--Select--</option>
											<option value="1" <?php echo ($exp_type==1) ? "selected" : "" ;?>>Land</option>
											<option value="2" <?php echo ($exp_type==2) ? "selected" : "" ;?>>Homes</option>
										</select>
								</div>
						...
						<li style="display:<?php echo $sty;?>" class="date_count_div">
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Number of Inspection Hours <span class="req">*</span></label>
									<div class="form_input">
									<div id="days_error" style="color:red"></div>
										<input name="total_count_date"   onchange="change_min(this.value, 2)" id="total_count_date" type="text" class="exp_input number_field" value="<?php echo $listDetail->row()->date_count;  ?>" <?php echo $reaOnly;?>>
						...
						<li style="display:<?php echo $st;?>" class="hour_count_div">
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Total Hours <span class="req">*</span></label>
									<div class="form_input">
						...
						<li>
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Property Category <span class="req">*</span></label>
						...
						<li>
							...
							?>
							 ...
							 <button class="btn btn-success" type="button" onclick="validate_form_basic(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
							 </div>
							<?php 
								}
							}else{
								...
								?>
								<div class="basic-next">
								 <button class="btn btn-success" type="button" onclick="next_form(event,'language_tab')"><?php if($this->lang->line('Continue') != '') { echo stripslashes($this->lang->line('Continue')); } else echo "Continue";?></button>
								 </div>
								<?php 
								}
							}
...
/*function change_min(value, min)
{
	...
	if(experience_type == 1)
	{
		...
		{
			$('#days_error').html('minimum value is 2');
			return false;
...
*/
			...
			<div id="language" class="tabcontent">
			  <h3>Language
			  <br><small>You will write your descriptions in this language and guests will expect you to speak it during experiences</small>
			  </h3>	
			   ...
			   <form id="lang_form" name="lang_form" method='post' class="form_container left_label listingInfo">
				...
				<li>
                    ...
                    <div class="exp-admin-lang">
                        ...
                        <?php } ?>
                        <li> <span style="width:100%; padding-right: 10px;"><?php if($this->lang->line('Addlanguages') != '') { echo stripslashes($this->lang->line('Addlanguages')); } else echo "Add languages you speak.";?></span> <a  data-toggle="modal" href="#myModal"  class="multiselect-add-more btn_small"><i class="fa fa-plus"></i> <?php if($this->lang->line('AddMore') != '') { echo stripslashes($this->lang->line('AddMore')); } else echo "Add More";?></a></li>
                        ...
                        <span class="text-normal remove cursor_pointer" href="javascript:void(0);" onclick="delete_languages(this,'<?php echo $language->language_code;?>')"> <i class="fa fa-times" aria-hidden="true"></i></span>
                        </small></li>
                        <?php } }?>
					...
					<?php 
						if($id!=0){
								?>
								<div class="lang-next">
								 <button class="btn btn-success" id="lang_btn" type="button" onclick="next_form(event,'organization_tab')"><?php if($this->lang->line('Continue') != '') { echo stripslashes($this->lang->line('Continue')); } else echo "Continue";?></button>
								 </div>
								<?php 
								}
						?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">
        	<a class="close"  data-dismiss="modal" type="button"><i class="fa fa-times" aria-hidden="true"></i>
        </a>
    ...
    <div class="panel-footer language-popup exp-button">
        ...
        <a class="btn btn-default" data-dismiss="modal" type="button"><?php if($this->lang->line('Close') != '') { echo stripslashes($this->lang->line('Close')); } else echo "Close";?></a>
...
window.location.reload();
			...
			<div id="organization" class="tabcontent">
			  ...
			  <small>You will write your descriptions in this language and guests will expect you to speak it during experiences. </small>
			  </h3>
			  
			   <form id="organization_form" name="organization_form" method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<li>
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Organization name <span class="req">*</span></label>
									<div class="form_input">
									
									<input name="organization" id="organizationn" type="text" class="exp_input" value="<?php echo $listDetail->row()->organization;  ?>" > 
						...
						<li>
								<div class="form_grid_12">
									<label class="field_title" for="user_id">About your Organization <span class="req">*</span></label>
									<div class="form_input">
	
										<textarea name="organization_des"  id="organization_des" type="text" class="exp_input" placeholder="About your organization" ><?php echo $listDetail->row()->organization_des;  ?></textarea>
						...
						<li>
							...
							<div class="exp-pic">
								...
								<button type="button" class="btn btn-default" onclick="next_form(event,'experience_title_tab')"><?php if($this->lang->line('Skip') != '') { echo stripslashes($this->lang->line('Skip')); } else echo "Skip";?></button>
								 
								<button class="btn btn-success" type="button" onclick="validate_form_organization(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="exp_title" class="tabcontent">
			  <h3>Experience Title <br><small>A title and summary displayed on your public experience page.</small></h3>
			    <form id="exp_title_form" name="exp_title_form"  method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
						...
						<li>
							<div class="form_grid_12">
								...
								<div class="form_input">
									...
									<input name="experience_title" maxlength="60" onkeyup="char_count(this)" id="experience_title" type="text" class="exp_input" value="<?php echo $listDetail->row()->experience_title;  ?>">
									<?php
									$string = str_replace(' ', '', $listDetail->row()->experience_title);
									$len=mb_strlen($string, 'utf8');
									$remaining=(60-$len);
									?>
									<span class="small_label"><span id="experience_title_char_count"><?php echo $remaining; ?></span> characters remaining</span>
								</div>
							</div>
						</li>
						...
						<li>
							...
							<div class="exp-pic">
								...
								<button class="btn btn-success" type="button" onclick="validate_form_exp_title(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="tagline" class="tabcontent">
			 <h3>Write a tagline <br><small>Clearly describe your in one short,catchy sentence. Start with a verb that tells guests what they will do.</small></h3>
			    <form id="exp_tagline_form" name="exp_tagline_form"  method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
						...
						<li>
							<div class="form_grid_12">
									<label class="field_title" for="user_id">Write your tagline here <span class="req">*</span></label>
								<div class="form_input">

									
									
									
							<input name="exp_tagline" maxlength="60" onkeyup="char_count(this)" id="exp_tagline" type="text" class="exp_input" value="<?php echo $listDetail->row()->exp_tagline;  ?>">
							<?php
							...
							?>
									...
									<span class="small_label"><span id="exp_tagline_char_count"><?php echo $remaining; ?></span> characters remaining</span>
								</div>
							</div>
						</li>
						...
						<li>
							...
							<div class="exp-pic">
								...
								<button class="btn btn-success" type="button" onclick="validate_form_tagline(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="photos" class="tabcontent">
			  ...
			  <br><small>Choose photos thae showcase the location and what guests will be doing. Photos must be at least (360 x 580) (W*H)pixels or Below (3000 X 3000px)  (W*H).</small></h3>
			  <div class="margin_top_20 margin_bottom_20" >
						<span class="error text-center" id="error_image">
						<small> * Please fill all mandatory fields</small>
						</span>
						</div>
			  <form id="exp_image_form" name="exp_image_form"  method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
			  ...
			  <ul class="tab-areas2">
               ...
               <?php //include('img_upload.php'); ?>
                <input type="hidden" name="prdiii" id="prdiii" value="<?php if(!empty($product_details)){ echo trim(stripslashes($product_details->row()->id)); } else { echo "0";}?>" />
                 ...
                 <div class="form_grid_12">
                  <label class="field_title" for="product_image">Experience Image <span class="req">*</span></label> 
                    ...
                    <tbody>
                      ...
                      <tr id="img_<?php echo $img->id ?>">
                        <td class="center tr_select "><input type="hidden" name="imaged[]" value="<?php echo $img->product_image; ?>"/>
                          <?php echo $j;?> </td>
                        <td class="center "><img src="<?php if(strpos($img->product_image, 's3.amazonaws.com') > 1)echo $img->product_image;else echo base_url()."server/php/experience/".$img->product_image; ?>"  height="80px" width="80px" /> </td>
				...
				<li>
              		...
              		<div class="form_grid_12">
		                 <label class="field_title"><?php if($this->lang->line('Video URL') != '') { echo stripslashes($this->lang->line('Video URL')); } else echo "Video URL";?></label>
					
		                  <div class="form_input">
		                    <input type="text" value="<?php echo $listDetail->row()->video_url;?>" placeholder="<?php if($this->lang->line('video_url') != '') { echo stripslashes($this->lang->line('video_url')); } else echo "Enter video link";?>" class="title_overview" onchange="javascript:experienceDetailview(this,<?php echo $product_details->row()->id; ?>,'video_url');" name="video_url" id="video_url" style="color:#000 !important;" />
		                  </div>
		            </div>
...
//alert(idval);
$(".dragndrop1").colorbox({width:"1000px", height:"500px", href:baseURL+"admin/experience/dragimageuploadinsert/?id="+idval});
}
...
function DeleteProductImage(prdID,Id){
	...
	//alert(baseURL+'admin/product/deleteProductImage');
		...
		<div id="what_we_do" class="tabcontent">
                        ...
                        <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Mention what you'll do";?></h3>
                        
                        <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Describe in detail what you'll be doing with your guests. The more information you can give, the better.";?> </p>
                    
                    
                   <form id="exp_what_we_do_form" name="exp_what_we_do_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
                        <div class="exp_det_right">
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">What you'll do <span class="req">*</span></label>
									<div class="form_input">
									<textarea maxlength="250" onkeyup="char_count(this)" name="what_we_do" id="what_we_do_add" class="exp_input" placeholder="What you'll do"><?php echo $listDetail->row()->experience_description;  ?></textarea>
										<?php
										$string = str_replace(' ', '', $listDetail->row()->experience_description);
										$len=mb_strlen($string, 'utf8');
										$remaining=(250-$len);
										?>
										<span class="small_label"><span id="what_we_do_add_char_count"><?php echo $remaining; ?></span> characters remaining</span>
									</div>									 
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_what_we_do(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="where_will_be" class="tabcontent">
			        ...
			        <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Mention where you'll be";?></h3>
                        
                    <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Name all the locations you'll visit. Give guests a glimpse of why they're meaningful.";?> </p>
                    
                    
                   <form id="exp_where_will_be_form" name="exp_where_will_be_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<small> * Please fill all mandatory fields</small>
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Mention where you'll be <span class="req">*</span></label>
									<div class="form_input">
									<textarea maxlength="250" onkeyup="char_count(this)" name="location_description" id="location_description" class="exp_input" placeholder="where you'll be"><?php echo $listDetail->row()->location_description;  ?></textarea>
										<?php
										$string = str_replace(' ', '', $listDetail->row()->location_description);
										$len=mb_strlen($string, 'utf8');
										$remaining=(250-$len);
										?>
										<span class="small_label"><span id="location_description_char_count"><?php echo $remaining; ?></span> characters remaining</span>
									</div>									 
						...
						<li>
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_where_you_will_be(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="where_will_meet" class="tabcontent">
                ...
                <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Let guests know exactly where you'll be meeting. The exact address wont't be shared with guests untill the book.";?> </p>
			...
			<li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    <input id="autocomplete-admin" name="address" onblur="getAddressDetails();" placeholder="" onFocus="geolocate()" type="text" value="<?php if(!empty($product_details)){ echo trim(stripslashes($product_details->row()->address)); }?>" style="width:370px;" class="large tipTop" title="Enter your Location"><span id="location_error_valid" style="color:#f00;display:none;"> Only Alphabets allowed!</span>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input">
                    <input placeholder=""  id="country" name="country" type="text" value="<?php if($productAddressData->row()->country != '')echo $productAddressData->row()->country; //echo $country;?>" style="width:370px;" class="large tipTop" title="Enter Country Name"><span id="country_error_valid" style="color:#f00;display:none;">Only Alphabets allowed!</span>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input" id="listCountryCnt">
                    <input placeholder="" id="state" name="state" type="text" value="<?php if($productAddressData->row()->state != '')echo $productAddressData->row()->state; //echo $state;?>" style="width:370px;" class="large tipTop" title="Enter State Name"><span id="state_error_valid" style="color:#f00;display:none;">Only Alphabets allowed!</span>
              ...
              <li>
                <div class="form_grid_12">
                  ...
                  <div class="form_input" id="listStateCnt">
					...
					//echo $city;?>" style="width:370px;" class="large tipTop" title="Enter City Name"><span id="city_error_valid" style="color:#f00;display:none;">Only Alphabets allowed!</span>
              ...
              <li>
                <div class="form_grid_12">
				  ...
				  <?php // echo "<pre>"; print_r($productAddressData->result()); ?>
                    <input type="text" name="post_code"   maxlength="11"  id="post_code" tabindex="8" class="large tipTop" title="Please enter the post code" value="<?php  if($productAddressData->row()->zip != '') echo $productAddressData->row()->zip; // echo $zip;?>" /><span id="post_code_error_valid" style="color:#f00;display:none;">Only Alphabets allowed!</span><span id="post_code_length_error" style="color:red;"></span>
                  </div>
	...
	function getAddressDetails(){
		...
		$.ajax({
			...
			<h3>Is there anything you’d like guests to know before booking?</h3>
				...
				<h3 style="display:none"><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "What else should guests know?";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Mention anything that guests will have to bring eith them or arrange on their own, like transportation.";?> </p>
			
                    
                   <form id="exp_notes_form" name="exp_notes_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<small> * Please fill all mandatory fields</small>
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Add notes <span class="req">*</span></label>
									<div class="form_input">
									<textarea maxlength="200" onkeyup="char_count(this)" name="note_to_guest" id="note_to_guest" class="exp_input" placeholder="Notes to guests"><?php echo $listDetail->row()->note_to_guest;  ?></textarea>
										<?php
										$string = str_replace(' ', '', $listDetail->row()->note_to_guest);
										$len=mb_strlen($string, 'utf8');
										$remaining=(200-$len);
										?>
										<span class="small_label"><span id="note_to_guest_char_count"><?php echo $remaining; ?></span> characters remaining</span>
									</div>									 
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_notes(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
...
function validate_form_notes(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Write Host's bio";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Describe about host and tell guests how came to be passionate about hosting this experience.";?> </p>
			
                    
                   <form id="exp_about_host_form" name="exp_about_host_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">About Host <span class="req">*</span></label>
									<div class="form_input">
									<textarea maxlength="250" onkeyup="char_count(this)" name="about_host" id="about_host" class="exp_input" placeholder="About Host"><?php echo $listDetail->row()->about_host;  ?></textarea>
										<?php
										$string = str_replace(' ', '', $listDetail->row()->about_host);
										$len=mb_strlen($string, 'utf8');
										$remaining=(250-$len);
										?>
										<span class="small_label"><span id="about_host_char_count"><?php echo $remaining; ?></span> characters remaining</span>
									</div>									 
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_about_host(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
...
function validate_form_about_host(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Have any guest requirements?";?></h3>
				
				<p>Mention anything that guests will have to bring with them or arrange on their own, like transportation. </p>
			
                    
                   <form id="exp_guest_req_form" name="exp_guest_req_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Guest requirements <span class="req">*</span></label>
									<div class="form_input">
									<textarea maxlength="250" onkeyup="char_count(this)" name="guest_requirement" id="guest_requirement" class="exp_input" placeholder="Details about Guest Requirement"><?php echo $listDetail->row()->guest_requirement;  ?></textarea>
										<?php
										$string = str_replace(' ', '', $listDetail->row()->guest_requirement);
										$len=mb_strlen($string, 'utf8');
										$remaining=(250-$len);
										?>
										<span class="small_label"><span id="guest_requirement_char_count"><?php echo $remaining; ?></span> characters remaining</span>
									</div>									 
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_guest_req(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
...
function validate_form_guest_req(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Maximum number of guests?";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "What's the number of guests you can accommodate?";?> </p>
			
                    
                   <form id="exp_group_size_form" name="exp_group_size_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title number" for="user_id">Group size <span class="req">*</span></label>
									<div class="form_input">
									<input class="title_overview number_field" placeholder="<?php if($this->lang->line('group_size') != '') { echo stripslashes($this->lang->line('group_size')); } else echo "Group size";?>" name="group_size" id="group_size_add" value="<?php echo $listDetail->row()->group_size;?>" maxlength="2">
							...
							if(!empty($minimum_stay)){
								?>
								<div class="select">
								<select name="group_size" id="group_size_add">
							...
							*/
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_group_size(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="price_content" class="tabcontent">
			  ...
			  <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Set a price per guest";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "The price of your experience is entirely up to you. Play with the calculator to see how much you'd earn depending on the number of guests.";?> </p>
			
                    
                   <form id="exp_price_form" name="exp_price_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Choose currency <span class="req">*</span></label>
									<div class="form_input">
										
										<select name="currency" id="currency_add" style="width:75px;display:inline-block;padding: 10px;height: 45px;">
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input class="title_overview number_field" style="width:50%;display:inline-block;" placeholder="<?php if($this->lang->line('price') != '') { echo stripslashes($this->lang->line('price')); } else echo "Price";?>" name="price" id="price_add" value="<?php echo ($listDetail->row()->price>0) ? intval($listDetail->row()->price):'' ;?>" maxlength="10">	
									</div>									 
							...
							<div class="form_grid_12">
								<div class="exp-pic">
									...
									<button class="btn btn-success" type="button" onclick="validate_form_price(event)"><?php if($this->lang->line('Save_and_Continue') != '') { echo stripslashes($this->lang->line('Save_and_Continue')); } else echo "Save & Continue";?></button>
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data==1){
					...
					//window.location.href ='<?php echo base_url()."admin/experience/add_experience_form_new/".$id;?>'+'#cancel_policy_tab';
				}
			}
		});
	}
			...
			<div id="cancel_policy" class="tabcontent">
			  ...
			  <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Cancellation Policy";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Cancel policy support to experiences.";?> </p>
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										 ...
										 <select class="gends" name="cancel_policy" id="cancel_policy_1" onchange="show_val(this);">
												...
												<option value="Flexible" <?php if(!empty($listDetail)){ if($listDetail->row()->cancel_policy=='Flexible'){echo 'selected="selected"';}}?>>Flexible</option>
												<option value="Moderate" <?php if(!empty($listDetail)){ if($listDetail->row()->cancel_policy=='Moderate'){echo 'selected="selected"';}}?>>Moderate</option>
											<option value="Strict" <?php if(!empty($listDetail)){ if($listDetail->row()->cancel_policy=='Strict'){echo 'selected="selected"';}}?>>Strict</option>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										...
										<input type="text" id="sec_deposit" name="sec_deposit" onchange="javascript:experienceDetailview(this,<?php echo $listDetail->row()->id; ?>,'security_deposit');" value="<?php  echo  ($listDetail->row()->security_deposit>0) ? intval($listDetail->row()->security_deposit) : ''; ?>" style="width:30%;display:inline-block;">
									</div>									 
								...
								<li>
									<div class="form_grid_12">
									<label class="field_title" for="user_id">Cleaning Fee<span class="req">*</span></label>
									<div class="form_input">
										<input type="text" name="currency" id="clean_currency" readOnly value="<?php echo $currentCurrency_type;?>" style="width:10%;display:inline-block;">
						
										<input type="text" id="cleaning_fees" name="cleaning_fees" onchange="javascript:experienceDetailview(this,<?php echo $listDetail->row()->id; ?>,'Cleaning_fees');" value="<?php  echo  ($listDetail->row()->Cleaning_fees>0) ? intval($listDetail->row()->Cleaning_fees) : ''; ?>" style="width:30%;display:inline-block;">
									</div>									 
								...
								<li>
								<div id="return_amount_percentage" <?php if($listDetail->row()->cancel_policy == 'Strict'){?>style="display:none" <?php } ?>>
									<div class="form_grid_12" >
										<label class="field_title" for="user_id">Return Amount<span class="req">*</span></label>

									<input  type="text" maxlength="2" value="<?php echo $listDetail->row()->cancel_percentage;?>" class="number_field required large tipTop" onkeypress="return check_for_num(event)" id="cancel_percentage" name="cancel_percentage" placeholder="Enter your return amount"  /> %
...
function validate_form_cancel_policy(e){
   ...
   <form id="exp_seo_form" name="exp_seo_form"  method="post"  accept-charset="UTF-8"  class="form_container left_label listingInfo">
      <input type="hidden" class=" col-sm-2"  id="experience_id" name="experience_id" value="<?php echo $listDetail->row()->experience_id ; ?>"/>
      <div class="dashboard_price_right">
         <div class="exp_det_right">
            <div class="margin_top_20 margin_bottom_20" >
            ...
            <ul class="tab-areas2">
               <li>
                  <div class="form_grid_12">
                     ...
                     <div class="form_input">
							<input name="meta_title" id="meta_title" type="text" tabindex="1" class="required large tipTop" title="Please enter the page meta title" value="<?php if(!empty($listDetail)){ echo trim(stripslashes($listDetail->row()->meta_title)); }?>"/>
                     </div>
                  </div>
               </li>
               <li>
                  <div class="form_grid_12">
                     ...
                     <div class="form_input">
                        ...
                        <textarea name="meta_keyword" id="meta_keywords" tabindex="13" style="width:370px;height:150px;" class="required large tipTop" title="Please enter the keywords"><?php if(!empty($listDetail)){ echo trim(stripslashes($listDetail->row()->meta_keyword)); }?></textarea>
               ...
               <li>
                     ...
                     <div class="form_grid_12" >
                        <label class="field_title" for="user_id">Meta Description</label>
							<textarea name="meta_description" id="meta_description" tabindex="13" style="width:370px;height:150px;" class="required large tipTop" title="Please enter the meta description"> <?php if(!empty($listDetail)){ echo trim(stripslashes($listDetail->row()->meta_description)); }?></textarea>
                     </div>
               ...
               <li>
                  <div class="form_grid_12">
                     <div class="exp-pic">
                        <button class="btn btn-success" type="button" onclick="validate_form_seo(event)"><?php if($this->lang->line('Save and Activate') != '') { echo stripslashes($this->lang->line('Save and Activate Experience')); } else echo "Save and Activate Experience";?></button>
                     </div>
                  </div>
               </li>
            </ul>
   ...
   <script>
      ...
      /* 	err=0;
      	...
      	if(meta_tittle=='' || meta_keywrds=='' || meta_description==''){
      		err=1;
      	}
    
      	if(err==1){
      		 $('#error_seo').fadeIn('slow', function () {
      			$(this).delay(5000).fadeOut('slow');
      		 });
      		 return false;
      	}
...
$('#organizationn').keydown(function(event)
{	
	lenSum = $('#organizationn').val().split(/[\s]+/); 
