    ...
    <div class="grid_12 margin_top_20">
		...
		<!---vertical tab-->
			<div class="tab">
			  ...
			  <button class="tablinks <?php  echo ($tagline==0) ? 'disabled_exp' : ''; ?>" onclick="openContent(event, 'tagline',this)" id="tagline_tab">Property Price<?php echo ($tagline==1) ? '<i class="fa fa-check green pull-right" aria-hidden="true"></i>' : ''; ?></button>
			  ...
			  <form id="basic_form" name="basic_form" method='post' class="form_container left_label listingInfo">
                    <div class="dashboard_price_right margin_top_20">
						...
						<li style="display:<?php echo $sty;?>" class="date_count_div">
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Number of Tour Hours <span class="req">*</span></label>
									<div class="form_input">
...
*/
			...
			<div id="language" class="tabcontent">
			  <h3>Language
			  <br><small>You will write your descriptions in this language and guests will expect you to speak it during your property tour</small>
			  </h3>	
...
window.location.reload();
			...
			<div id="organization" class="tabcontent">
			  ...
			  <small>You will write your descriptions in this language and guests will expect during a property tour. </small>
			  </h3>
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="exp_title" class="tabcontent">
			  <h3>Property Title <br><small>A title and summary displayed on your public property page.</small></h3>
			    <form id="exp_title_form" name="exp_title_form"  method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
						...
						<li>
							<div class="form_grid_12">
									<label class="field_title" for="user_id">Property Title <span class="req">*</span></label>
								<div class="form_input">
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="tagline" class="tabcontent">
			 <h3>Write a property price <br><small>Clearly state your property price. State the property price.</small></h3>
			    <form id="exp_tagline_form" name="exp_tagline_form"  method="post"  accept-charset="UTF-8" class="form_container left_label listingInfo">
						...
						<li>
							<div class="form_grid_12">
									<label class="field_title" for="user_id">State Property Price <span class="req">*</span></label>
								<div class="form_input">
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="photos" class="tabcontent">
			  <h3 class="margin_bottom_20">Add photos for your property 
			  
			  <br><small>Choose photos that showcase the property. Photos must be at least (360 x 580) (W*H)pixels or Below (3000 X 3000px)  (W*H).</small></h3>
			  <div class="margin_top_20 margin_bottom_20" >
...
function DeleteProductImage(prdID,Id){
	...
	//alert(baseURL+'admin/product/deleteProductImage');
		...
		<div id="what_we_do" class="tabcontent">
                        ...
                        <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "State the number of bathrooms in the property";?></h3>
                        
                        <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "State the number of bathrooms.";?> </p>
                    ...
                    <div class="dashboard_price_right">
                        <div class="exp_det_right">
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Number of Bathrooms <span class="req">*</span></label>
									<div class="form_input">
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="where_will_be" class="tabcontent">
			        ...
			        <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "State the property size";?></h3>
                        
                    <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Property Size.";?> </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<small> * Please fill all mandatory fields</small>
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Property Size <span class="req">*</span></label>
									<div class="form_input">
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="where_will_meet" class="tabcontent">
                ...
                <p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "State the exact address of the property. The exact address wont't be shared with guests untill the book.";?> </p>
	...
	function getAddressDetails(){
		...
		$.ajax({
			...
			<h3>Describe the property</h3>
				...
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Describe the property in details.";?> </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<small> * Please fill all mandatory fields</small>
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Describe the property <span class="req">*</span></label>
									<div class="form_input">
...
function validate_form_notes(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Number of Bedrooms";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "State the number of bedrooms in the property.";?> </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Number of Bedrooms <span class="req">*</span></label>
									<div class="form_input">
...
function validate_form_about_host(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Contact phone numbers";?></h3>
				
				<p>List your contact phone numbers sepatated by commas. </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Contact Phone Number(s) <span class="req">*</span></label>
									<div class="form_input">
...
function validate_form_guest_req(e){
	...
	if(err==1){
		...
		$.ajax({
			...
			<h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Number of toilets";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "What's the number of toilets in the property?";?> </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title number" for="user_id">Number of Toilets <span class="req">*</span></label>
									<div class="form_input">
	...
	if(err==1){
		...
		$.ajax({
			...
			<div id="price_content" class="tabcontent">
			  ...
			  <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Set a price for your property";?></h3>
				
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "The price of your property is up to you.";?> </p>
                    ...
                    <div class="dashboard_price_right">
						...
						<div class="margin_top_20 margin_bottom_20" >
						  ...
						  <ul class="tab-areas2">
								...
								<div class="form_grid_12">
									<label class="field_title" for="user_id">Property Price <span class="req">*</span></label>
									<div class="form_input">
		...
		$.ajax({
			...
			<div id="cancel_policy" class="tabcontent">
			  ...
			  <h3><?php if($this->lang->line('experience_details') != '') { echo stripslashes($this->lang->line('experience_details')); } else echo "Cancellation Policy";?></h3>
				...
				<p><?php if($this->lang->line('Aexperiencetitleandsummary') != '') { echo stripslashes($this->lang->line('Aexperiencetitleandsummary')); } else echo "Cancellation Policy.";?> </p>
