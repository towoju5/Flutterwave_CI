						...
						?>
								<tr>
									...
									if ($allPrev == '1' || in_array('2', $Experience)){
										...
										if ($mode == '0'){
									?>
										<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/experience/change_experienceType_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
									<?php
										}else {	
									?>
										<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/experience/change_experienceType_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
									<?php 
										}
									}else {
									?>
									...
									<td class="center">
									<?php if ($allPrev == '1' || in_array('2', $Experience)){?>
										<span><a class="action-icons c-edit" href="admin/experience/edit_experienceType_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
									<?php }?>
										<span><a class="action-icons c-suspend" href="admin/experience/view_experienceType/<?php echo $row->id;?>" title="View">View</a></span>
									<?php if ($allPrev == '1' || in_array('3', $Experience)){?>	
										<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/experience/delete_experienceType/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
									<?php }?>
									
									<?php if ($allPrev == '1' || in_array('2', $Experience)){?>
									 
		                            <?php if($row->featured=='0'){ ?>
		                            <span id="feature_<?php echo $row->id;?>"><a class="c-unfeatured" href="javascript:ChangeFeaturedExperienceType('1','<?php echo $row->id;?>')" title="Click To Featured">Un-Featured</a></span>
		                            <?php }else{ ?>
		                            <span id="feature_<?php echo $row->id;?>"><a class="c-featured" href="javascript:ChangeFeaturedExperienceType('0','<?php echo $row->id;?>')" title="Click To Un-Featured" >Featured</a></span>
		                            <?php } ?>
