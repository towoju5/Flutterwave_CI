...
//$route['order/(:any)/(:any)'] = "site/order/$1/$2";
...
$route['image'] = "site/product/image";



/* malar -8/7/2017 wallet dashboard link*/
...
$route['my_trips'] = "site/bookings/my_trips";
...
//$route['display_dispute'] = "site/product/display_dispute";
...
$route['additional_details/(:any)'] = "site/experience/additional_details/$1"; 

$route['location_details/(:any)'] = "site/experience/location_details/$1"; 

$route['group_details/(:any)'] = "site/experience/group_details/$1"; 
...
$route['guide-payment-success/(:any)'] = "site/experience/guidepayment_success/$1"; // new experience payment by guide

$route['explore_experience']  = "site/experience/explore_experience/$1";

$route['explore_experience/(:any)']  = "site/experience/explore_experience/$1";
...
// $route['experience_inbox/(:any)'] = "site/experience/dashboard_inbox/$1";

$route['experience_conversation/(:any)'] = "site/experience/host_conversation/$1";
...
$route['experience/(:any)/wishlists'] = "site/experience/wishlists";



$route['experience/(:any)/wishlists/(:any)/edit'] = "site/experience/display_user_lists_edit";

$route['experience/(:any)/wishlists/(:any)'] = "site/experience/display_user_lists_home";
